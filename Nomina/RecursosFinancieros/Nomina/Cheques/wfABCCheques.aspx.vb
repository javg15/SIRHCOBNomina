...
Partial Class wfABCCheques
    ...
    Protected Sub btnConsultar_Click(sender As Object, e As System.EventArgs) Handles btnConsultar.Click
        ...
        gvCheques.DataSource = oNomina.getCheques(CShort(ddlQnas.SelectedValue), CShort(ddlAños.SelectedValue), _
                                                 CByte(ddlMeses.SelectedValue), ddlTiposDeCheques.SelectedValue)
        gvCheques.DataBind()
