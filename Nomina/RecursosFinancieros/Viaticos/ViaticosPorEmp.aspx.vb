...
Partial Class ViaticosPorEmp
    ...
    Private Sub BindgvHistoriaCompe()
        ...
        lbAddCompen.Visible = dtNumsAdic.Rows.Count > 0 And CShort(ds.Tables(4).Rows(0).Item("Anio")) = CShort(ddlAnios.SelectedValue)
        lbAddBPA.Visible = gvHistoriaCompe.Rows.Count > 0 And CShort(ds.Tables(4).Rows(0).Item("Anio")) = CShort(ddlAnios.SelectedValue)
    End Sub
    Private Sub BindgvHistoriaCompe2(ByVal pClaveCobro As String)
        ...
        lbAddCompenBPA.Visible = dtNumsAdic.Rows.Count > 0 And CShort(ds.Tables(3).Rows(0).Item("Anio")) = CShort(ddlAnios.SelectedValue)
    End Sub
    ...
    Private Sub BindgvAnios()
        ...
        If vlRFCEmp <> String.Empty Then
            pnl1.GroupingText = "Años en los que el empleado " + hfNomEmp.Value + " ha tenido compensación"
            ...
            If ddlAnios.Items.Count > 0 Then
                ...
                pnl2.Visible = True
                pnl2.GroupingText = "Desglose mensual de compensaciones recibidas durante el año: " + ddlAnios.SelectedItem.Text
                BindgvHistoriaCompe()
                pnl4.Visible = False
            Else
                pnl1.Visible = True
    ...
    Protected Sub ibModificar_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
        ...
        SetVisibleBotones_wucBuscaEmps(False)
        pnl5.GroupingText = "Información de la compensación actual del empleado"
    ...
    Protected Sub lbAddCompen_Click(sender As Object, e As System.EventArgs) Handles lbAddCompen.Click
        ...
        SetVisibleBotones_wucBuscaEmps(False)
        pnl5.GroupingText = "Asignar compensación al empleado"
