...
Imports System.Data
Partial Class WebControls_wucSearchEmpsAux
    ...
    Private Sub MuestraFoto()
        ...
        If Left(Request.ServerVariables("REMOTE_ADDR").ToString, 4) = "10." Or Request.ServerVariables("REMOTE_ADDR").ToString = "::1" Then
