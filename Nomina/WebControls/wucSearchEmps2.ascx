<%@ Control Language="VB" EnableViewState="true" AutoEventWireup="false" CodeFile="wucSearchEmps2.ascx.vb"
    Inherits="WebControls_wucSearchEmps2" %>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;" valign="middle">
                                            ...
                                            <asp:Button ID="BtnCancelSearch" runat="server" CausesValidation="False" 
                                                SkinID="SkinBoton" Text="Cancelar" ToolTip="Cancelar búsqueda" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left;">
