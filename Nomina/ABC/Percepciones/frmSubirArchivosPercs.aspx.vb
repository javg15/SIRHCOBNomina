...
Partial Class frmSubirArchivosPercs
    ...
    Private Sub BindQnas()
        ...
        With Me.ddlQnasAbiertasParaCaptura
            ...
            .DataBind()
            If Not AjaxFileUpload1.IsInFileUploadPostBack Then
                Session.Add("strQnaParaUploadPercs", ddlQnasAbiertasParaCaptura.SelectedItem.Text)
            Else
                ddlQnasAbiertasParaCaptura.SelectedItem.Text = Session("strQnaParaUploadPercs")
            End If
    ...
    Protected Sub AjaxFileUpload1_UploadComplete(sender As Object, e As AjaxControlToolkit.AjaxFileUploadEventArgs)
        ...
        If Not Directory.Exists(ConfigurationManager.AppSettings("RutaImportarPercepciones") + "\" + strAnio) Then
            Directory.CreateDirectory(ConfigurationManager.AppSettings("RutaImportarPercepciones") + "\" + strAnio)
        End If

        If Not Directory.Exists(ConfigurationManager.AppSettings("RutaImportarPercepciones") + "\" + strAnio + "\" + strQna.Replace("-", "_")) Then
            Directory.CreateDirectory(ConfigurationManager.AppSettings("RutaImportarPercepciones") + "\" + strAnio + "\" + strQna.Replace("-", "_"))
        End If
