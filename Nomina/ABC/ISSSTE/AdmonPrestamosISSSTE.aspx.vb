...
Partial Class AdmonPrestamosISSSTE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            ElseIf Request.Params("TipoOperacion") = "1" Then
                ...
                If MultiView1.GetActiveView().ID = "viewError" Then Exit Sub
            End If
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            ...
            With oDeduccion
                ...
                .NumQnas = IIf(chbxEspecificarNumQuincenas.Checked = True, CType(txtbxNumQnas.Text, Short), 0)
                If Request.Params("TipoOperacion") = "0" Then
                    .IdDeducCapturada = CType(Request.Params("IdDeducCapturada"), Integer)
                    .UpdPrestamoISSSTE(Deduccion.TipoActualizacion.ParaPago, CType(Session("ArregloAuditoria"), String()))
                    lbOtraOperacion.Visible = True
                Else
                    .InsertaPrestamoISSSTE(Deduccion.TipoInsercion.ParaPago, CType(Session("ArregloAuditoria"), String()))
                    lbOtraOperacion.Visible = False
                End If
            End With
