...
Partial Class ABC_Nomina_OpcionesDeCalculo_Borrar
    Inherits System.Web.UI.Page

    Private ThreadCalculo As Thread
    Private dtErroresCalculoNomina As DataTable

    Private Sub EliminaInfQuincena(Optional ByVal RFC As String = "")
    ...
    Private Sub CalculaNomina(pTipoCalculo As String)
        ...
        'Dim arregloRFC As New ArrayList
        'Dim RFC As String
        ...
        If Session("CalculandoNomina") = True Then  '22/09/2009
            ...
            Dim dtPlanteles, dtEmpleados As DataTable
            ...
            If pTipoCalculo = "0" Then
                dtPlanteles = oPlantel.ObtenTodos(True)
            Else
                If Me.ChkBxCalculoHaciaAdelante.Checked Then
                    dtPlanteles = oPlantel.ObtenTodos(CType(Me.ddlPlanteles.SelectedValue, Short), True)
                Else
                    dtPlanteles = oPlantel.ObtenPorId(CType(Me.ddlPlanteles.SelectedValue, Short))
                End If
            End If
            ...
            For Each drPlantel In dtPlanteles.Rows
                ...
                oNom.EliminaPagoQuincenal(CType(Me.ddlQnasParaCalculo.SelectedValue, Short), _
                                            CShort(drPlantel("IdPlantel").ToString), _
                ...
                dtEmpleados = oEmpleado.ObtenPorPlantel(CShort(drPlantel("IdPlantel").ToString), _
                ...
                For Each drEmpleado In dtEmpleados.Rows
                    ...
                    If Session("CalculandoNomina") Is Nothing Then ' 22/09/2009
                        ...
                        Exit Sub  '22/09/2009
                    End If  '22/09/2009
                    Session("Empleado") = "Empleado: "  '22/09/2009
                    Session("Empleado2") = drEmpleado("ApePatEmp").ToString + _
                                        " " + drEmpleado("ApeMatEmp") + " " + drEmpleado("NomEmp")  '22/09/2009
