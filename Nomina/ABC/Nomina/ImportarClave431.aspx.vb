...
Partial Class ImportarClave431
    ...
    Private Sub LlenadrInconsistenciaDeducMasiva(ByVal s As String, ByVal IdError As Short)
        ...
        drInconsistenciaDeducMasiva(2) = CInt(s.Substring(102, 3))
    ...
    Private Sub Procesa()
        ...
        Dim i As Integer
        Dim flagItemsVisibles As Boolean = False

        strAnio = Left(ddlQnasAbiertasParaCaptura.SelectedItem.Text, 4)
        strQna = ddlQnasAbiertasParaCaptura.SelectedItem.Text

        ddlDeducciones.Items.Clear()
        ddlDeducciones.Items.Add(New ListItem("[431] - DESC. PRESTAMO ISSSTE", "31"))
        ddlDeducciones.Items.Add(New ListItem("[534] - CREDITOS ADICIONALES ISSSTE", "136"))

        i = 0
        While i <= ddlDeducciones.Items.Count - 1
            ...
            If Not File.Exists(TargetPath) Then
                ddlDeducciones.Items(i).Enabled = False
            Else
                ddlDeducciones.Items(i).Enabled = True
            End If
            i = i + 1
        End While
        ...
        i = 0
        While i <= ddlDeducciones.Items.Count - 1
            If ddlDeducciones.Items(i).Enabled Then
                flagItemsVisibles = True
            End If
            i = i + 1
        End While

        'If ddlDeducciones.Items.Count = 0 Then
        If flagItemsVisibles = False Then
        ...
        Try
            ...
            While sr.Peek() <> -1
                ...
                Else
                    ...
                    If drDeduccionMasiva(0).ToString = "MOAJ760217HVZNMN05" Then
                    ...
                    End Try
                    Try
                        drDeduccionMasiva(2) = CInt(s.Substring(102, 3)) 'NumQnas
            ...
            Me.btnGuardar.Visible = gvDeducMasivas.Rows.Count > 0 And CBool(dtPermisos.Rows(0).Item("Insercion"))
