...
Partial Class AdministracionCargaHoraria
        ...
        With oValidacion
            ...
            If Request.Params("ValidacionAlCargarPagina") Is Nothing = False Then
                If Not oValidacion.ValidaPaginasOperacion(dsValida, False) Then
                    ...
                    MultiView1.SetActiveView(viewErrorValidaciones)
                    Exit Sub
                Else
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            ElseIf Request.Params("TipoOperacion") = "0" Or Request.Params("TipoOperacion") = "1" Or Request.Params("TipoOperacion") = "4" Then
                ...
                If Request.Params("TipoOperacion") = "4" Then
                    WucBuscaEmpleados2_E = CType(dvCargaHoraria.FindControl("WucBuscaEmpleados2_E"), UserControl)
                    BtnNewSearchI = CType(WucBuscaEmpleados2_E.FindControl("BtnNewSearch"), Button)
                    BtnCancelSearchI = CType(WucBuscaEmpleados2_E.FindControl("BtnCancelSearch"), Button)
                    BtnSearchI = CType(WucBuscaEmpleados2_E.FindControl("BtnSearch"), Button)

                    ddlPlanteles.Enabled = False
                    txtbxCantidad.Enabled = False
                    ddlEstatus.Enabled = False
                    ddlTipoHora.Enabled = False
                    ddlNombramiento.Enabled = False
                    ddlMotivoInterinato.Enabled = False
                    BtnNewSearchI.Visible = False
                    BtnCancelSearchI.Visible = False
                    BtnSearchI.Visible = False
                    ddlGrupos.Enabled = False
                    ddlSemestres.Enabled = False
                    ddlQnaIni.Enabled = False
                ...
                If (Request.Params("TipoOperacion") = "1" And Request.Params("AddInterina") Is Nothing = False) Then
                    ...
                    Me.MultiView1.SetActiveView(viewExito)
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If MultiView1.GetActiveView().ID = "viewErrorValidaciones" Then
                If Session("URLAnt") Is Nothing = False Then
                    ...
                    Else
                        lbOtraOperacion1.PostBackUrl = "~/" + Session("URLAnt") + vlComplementoURL
                    End If
                Else
                    lbOtraOperacion1.PostBackUrl = "~/MenuPrincipal.aspx"
                End If
        ...
        Catch Ex As Exception
            Me.MultiView1.SetActiveView(viewErrorInesperado)
            ...
            If Session("URLAnt") Is Nothing = False Then
                If Session("URLAnt").ToString.Contains(Request.Url.Segments(Request.Url.Segments.Length - 1).ToString) Then
                    lbOtraOperacion3.PostBackUrl = "~/MenuPrincipal.aspx"
                Else
                    lbOtraOperacion3.PostBackUrl = "~/" + Session("URLAnt") + vlComplementoURL
                End If
            Else
                lbOtraOperacion3.PostBackUrl = "~/MenuPrincipal.aspx"
            End If
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If IsPostBack = False Then
            ...
            btnCancelar = CType(dvCargaHoraria.FindControl("btnCancelar"), Button)
    ...
    Protected Sub lbOtraOperacion_Click(sender As Object, e As System.EventArgs) Handles lbOtraOperacion.Click
        MultiView1.SetActiveView(viewHoras)
    End Sub
    ...
    Protected Sub lbOtraOperacion4_Click(sender As Object, e As System.EventArgs) Handles lbOtraOperacion4.Click
        MultiView1.SetActiveView(viewHoras)
    End Sub
End Class
