...
Partial Class ABCPlazas2
    ...
    Protected Sub Page_LoadComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            ...
            txtbxClaveCatego.Text = String.Empty
            txtBxHoras.Text = String.Empty
            txtbxConsecutivo.Text = String.Empty
        End If
    End Sub
    ...
    Protected Sub btnValidaPlaza1_Click(sender As Object, e As System.EventArgs) Handles btnValidaPlaza1.Click
        txtbxZE.Text = IIf(txtbxZE.Text.PadLeft(2, "0") = "00", "", txtbxZE.Text.PadLeft(2, "0"))
        txtbxClaveCatego.Text = IIf(txtbxZE.Text.PadLeft(3, "0") = "000", "", txtbxClaveCatego.Text.PadLeft(3, "0"))
        Page.Validate("gpoValidaPlaza1")
