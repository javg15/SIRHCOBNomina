...
<asp:UpdatePanel ID="UpdPnlMain" runat="server">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:Panel ID="ContentPanelPlazasBase" runat="server" Width="100%" CssClass="collapsePanel">
            ...
            <asp:Panel ID="pnlDatos" runat="server" Width="100%" GroupingText="Plazas">
                                <asp:GridView ID="gvDatos" runat="server" AutoGenerateColumns="False" EmptyDataText="No existe información."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Plantel"><ItemTemplate><asp:Label ID="lbl2" runat="server" Text='<%# Bind("DescPlantelPlaza") %>'></asp:Label></ItemTemplate><HeaderStyle HorizontalAlign="Center" /><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Función"><ItemTemplate><asp:Label ID="lbl4" runat="server" Text='<%# Bind("Funcion") %>'></asp:Label></ItemTemplate><HeaderStyle HorizontalAlign="Center" /><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
