...
Imports System.Data
Partial Class Admon_ABCAniosMesesCompeCopy
    ...
    Private Sub SetVisibilidadDeColumnas()
        ...
        Me.gvAniosMesesCompe.Columns(11).Visible = CBool(dt.Rows(0).Item("Actualizacion"))
        Me.gvAniosMesesCompe.Columns(12).Visible = False
        Me.gvAniosMesesCompe.Columns(13).Visible = CBool(dt.Rows(0).Item("Insercion"))
    ...
    Protected Sub gvAniosMesesCompe_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles gvAniosMesesCompe.RowEditing
        ...
        Me.gvAniosMesesCompe.Columns(13).Visible = False
    ...
    Protected Sub gvAniosMesesCompe_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles gvAniosMesesCompe.RowUpdating
        ...
        If lblAnio_E Is Nothing = False Then
            ...
            '        ChkBxISRRecalculado_E.Checked, tbComentarios_E.Text, CDate(tbFchPago_E.Text), ChkBxMesNormal_E.Checked, CType(Session("ArregloAuditoria"), String()))
        End If
