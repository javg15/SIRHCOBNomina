...
Partial Class VisorDeReportesCR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            End Select
            oCR.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, False, "")
            'PDF(oCR)
        End If
    End Sub

    'Private Sub PDF(pCR As ReportDocument)
    '    Try
    '        Dim l_stream As System.IO.Stream
    '        l_stream = pCR.ExportToStream(ExportFormatType.PortableDocFormat)
