...
Partial Class CopyHistoriaPlazas
    ...
    Private Sub BindDatos()
        ...
        If oEmp.RFC <> String.Empty Then
            'Nomina\MovsDePersonal\ABC\wfCapturaNuevoMovDePersonal.aspx
            lbCapturaMovs.PostBackUrl = "../../MovsDePersonal/ABC/wfCapturaNuevoMovDePersonal.aspx?TipoOperacion=1&RFCEmp=" + hfRFC.Value
    ...
    Protected Sub gvPlazasVigentes_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvPlazasVigentes.RowDataBound
        ...
        Select Case e.Row.RowType
            ...
            Case DataControlRowType.EmptyDataRow, DataControlRowType.Footer
                ...
                lbAsignarPlaza.Visible = False 'oEmpleadoPlaza.SeLePudenAgregarMasPlazas(hfRFC.Value)
