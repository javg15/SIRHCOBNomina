<%@ Page Language="VB" MasterPageFile="~/MasterPageSesionIniciada.master" AutoEventWireup="false"
    CodeFile="Historia.aspx.vb" Inherits="Consultas_Empleados_Historia" Title="COBAEV - Nómina - Historia empleado"
                                                        ...
                                                        <asp:GridView ID="gvPlazasBase" runat="server" EmptyDataText="El empleado no tiene registradas plazas base"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Plazas Base">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <!--
                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("CvePlazaTipo") %>' ToolTip='<%# Bind("ToolTipPlazaTipo") %>'></asp:Label>                                                                        
                                                                        <asp:Label ID="Label4" runat="server" Text="-"></asp:Label>
                                                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("ZonaEco") %>' ToolTip='<%# Bind("ToolTipZonaEco") %>'></asp:Label>                                                                        
                                                                        <asp:Label ID="Label6" runat="server" Text="-"></asp:Label>
                                                                        <asp:Label ID="Label7" runat="server" Text='<%# Bind("CvePlazaDiferenciador") %>' ToolTip='<%# Bind("ToolTipPlazaDiferenciador") %>'></asp:Label>
                                                                        <asp:Label ID="Label8" runat="server" Text="-"></asp:Label>
                                                                        <asp:Label ID="Label9" runat="server" Text='<%# Bind("CveCategoCOBACH") %>' ToolTip='<%# Bind("ToolTipCatego") %>'></asp:Label>
                                                                        <asp:Label ID="Label10" runat="server" Text="-"></asp:Label>
                                                                        <asp:Label ID="Label11" runat="server" Text='<%# Bind("strHrsJornada")%>' ToolTip="Horas asociadas a la plaza"></asp:Label>
                                                                        <asp:Label ID="Label12" runat="server" Text="-"></asp:Label>
                                                                        <asp:Label ID="Label13" runat="server" Text='<%# Bind("Consecutivo") %>' ToolTip="Consecutivo de la plaza"></asp:Label>
                                                                        <asp:Label ID="Label14" runat="server" Text="==>"></asp:Label>
                                                                        <asp:Label ID="Label15" runat="server" Text='<%# Bind("DescCatego") %>'></asp:Label>
                                                                        -->
                                                                ...
                                                                <asp:TemplateField HeaderText="Inicio (Base)">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblInicioBase" runat="server" Text='<%# Bind("InicioBase") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Fin (Base)">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Image ID="imgInfTitular" runat="server" ImageUrl="~/Imagenes/Warning1.png" visible='<%# Bind("VisibleToolTipBaseVigente") %>' tooltip='<%# Bind("ToolTipBaseVigente") %>' />
                                                                        <asp:Label ID="lblFinBase" runat="server" Text='<%# Bind("FinBase") %>' ></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Inicio (Ocupante)">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblInicioOcupante" runat="server" Text='<%# Bind("InicioOcup") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Fin (Ocupante)">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFinOcupante" runat="server" Text='<%# Bind("FinOcup") %>' ></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Plantel (Ocupante)">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPlantel" runat="server" Text='<%# Bind("OcupantePlantel") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Observaciones (Base)">
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                    <ItemTemplate>
