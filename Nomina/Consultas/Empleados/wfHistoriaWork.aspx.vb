    ...
    Protected Sub gvPlazasVigentes_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvPlazasVigentes.RowDataBound
        ...
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                ...
                'ibDetalles.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/wfAdministracionPlazasWork.aspx?TipoOperacion=4&IdPlaza=" + lblIdPlaza.Text + "'); return false;"
                ibDetalles.PostBackUrl = "../../ABC/Plazas/wfAdministracionPlazasWork.aspx?TipoOperacion=4&IdPlaza=" + lblIdPlaza.Text
                ...
                ibBaja.PostBackUrl = "../../ABC/Plazas/wfAdministracionPlazasWork.aspx?TipoOperacion=2&IdPlaza=" + lblIdPlaza.Text
