...
Partial Class Consultas_PagosProvisionados
    ...
    Private Sub BindDatos()
        ...
        If txtbxRFC.Text <> String.Empty Then
            dt = oEmp.ObtenPagosProvisionados(RFC, CShort(ddlAños.SelectedValue))
            gvPagosPorvisionados.DataSource = dt
            If Not Session("RFCParaCons") Is Nothing Or hfNomEmp.Value.Trim <> String.Empty Then
                ddlAños.Enabled = True
                Me.lblEmpInf.Text = "Información relacionada con el empleado: " + IIf(hfNomEmp.Value = String.Empty, Session("ApePatParaCons") + " " + Session("ApeMatParaCons") + " " + Session("NombreParaCons"), hfNomEmp.Value) + ". Ejercicio: " + ddlAños.SelectedValue
            Else
                ddlAños.Enabled = False
                Me.lblEmpInf.Text = String.Empty
            End If
            gvPagosPorvisionados.DataBind()
            pnl1.Visible = True
            pnl2.Visible = True
        Else
            ddlAños.Enabled = False
    ...
    Protected Sub gvPagosPorvisionados_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvPagosPorvisionados.RowDataBound
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                e.Row.Attributes.Add("OnMouseOver", "Resaltar_On(this);")
                e.Row.Attributes.Add("OnMouseOut", "Resaltar_Off(this);")
                e.Row.Attributes("OnClick") = Page.ClientScript.GetPostBackClientHyperlink(gvPagosPorvisionados, "Select$" + e.Row.RowIndex.ToString)
        End Select
    End Sub
End Class
