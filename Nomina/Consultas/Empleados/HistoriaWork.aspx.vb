...
Imports System.Data
Partial Class Consultas_Empleados_Historia_Work
    ...
    Private Sub BindDatos()
        ...
        If oEmp.RFC <> String.Empty Then
            Me.gvPlazasVigentes.DataSource = oEmp.ObtenPlazasVigentesHistoria()
    ...
    Protected Sub gvPlazasVigentes_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvPlazasVigentes.RowDataBound
        ...
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                ...
                'ibDetalles.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=4&IdPlaza=" + lblIdPlaza.Text + "'); return false;"
                ibDetalles.PostBackUrl = "../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=4&IdPlaza=" + lblIdPlaza.Text
                ...
                ibModificar.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=0&IdPlaza=" + lblIdPlaza.Text + "'); return false;"
                ibBaja.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=2&IdPlaza=" + lblIdPlaza.Text + "');"
            ...
            Case DataControlRowType.EmptyDataRow, DataControlRowType.Footer
                ...
                'lbAsignarPlaza.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=1&RFCEmp=" + hfRFC.Value + "');"
                lbAsignarPlaza.PostBackUrl = "../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=1&RFCEmp=" + hfRFC.Value
                lbAsignarPlazaCopia.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Plazas/AdministracionPlazasWork.aspx?TipoOperacion=1&RFCEmp=" + hfRFC.Value + "&CopiarUltVig=SI');"
        End Select
    End Sub
