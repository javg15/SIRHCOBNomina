...
Partial Class DatosCOBAEV
    ...
    Protected Sub dvDatosLab_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles dvDatosLab.DataBound
        ...
        Dim lblIdUsuario As Label = CType(Me.dvDatosLab.Rows(0).FindControl("lblIdUsuario"), Label)
        Dim lblNombreAnalista As Label = CType(Me.dvDatosLab.Rows(0).FindControl("lblNombreAnalista"), Label)
        ...
        dt = oUsr.ObtenPermisosSobreTabla(Session("Login"), "EmpleadosDatosLaborales")
        ...
        If lblIdEmp Is Nothing = False Then
            ...
            lbModifDatosLab.PostBackUrl = "../../ABC/Empleados/AdministracionDatosLaborales.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text
        End If
        lbModifDatosLab.Visible = CBool(dt.Rows(0).Item("Actualizacion"))
    End Sub
