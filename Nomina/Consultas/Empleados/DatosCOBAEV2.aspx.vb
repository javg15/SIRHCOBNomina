...
Partial Class Consultas_Empleados_DatosCOBAEV2
    ...
    Private Sub BindDatos()
        ...
        If oEmp.RFC <> String.Empty Then
            ...
            Dim dtDatosLab2 As DataTable

            dtDatosLab = oEmp.ObtenDatosLaborales()
            dtDatosLab2 = oEmp.ObtenDatosLaboralesPorRFCEmp(IIf(Session("RFCParaCons") Is Nothing, hfRFC.Value.Trim, Session("RFCParaCons")))
            dvDatosLab.DataSource = dtDatosLab2
    ...
    Protected Sub dvAntiguedad_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles dvAntiguedad.DataBound
        ...
        If lblIdEmp Is Nothing = False Then
            ...
            lbModifAnt.PostBackUrl = "../../ABC/Empleados/AdministracionAntiguedad.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text
        End If
    End Sub
    ...
    Protected Sub dvSegSoc_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles dvSegSoc.DataBound
        ...
        If lblIdEmp Is Nothing = False Then
            ...
            lbModifSegSoc.PostBackUrl = "../../ABC/Empleados/AdmonDatosSegSoc.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text
        End If
    End Sub
    ...
    Protected Sub dvPagomatico_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles dvPagomatico.DataBound
        ...
        If lblIdEmp Is Nothing = False Then
            'lbModifPagomatico.OnClientClick = "javascript:abreVentMedAncha('../../ABC/Empleados/AdmonDatosPagomatico.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text + "&ValidacionAlCargarPagina=SI'); return false;"
            'lbModifPagomatico.PostBackUrl = "../../ABC/Empleados/wfAdmonDatosPagomatico.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text + "&ValidacionAlCargarPagina=SI"
            lbModifPagomatico.PostBackUrl = "../../ABC/Empleados/wfAdmonDatosPagomatico.aspx?TipoOperacion=0&IdEmp=" + lblIdEmp.Text + "&NomEmp=" + txtbxNomEmp.Text.Trim + "&ValidacionAlCargarPagina=SI"
        End If
    End Sub
