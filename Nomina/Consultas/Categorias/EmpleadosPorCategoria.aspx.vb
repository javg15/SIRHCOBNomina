...
Partial Class Consultas_Categorias_EmpleadosVigentes
    ...
    Private Sub BindDatos()
        ...
        Me.gvEmpleados.DataSource = oCatego.ObtenEmpleadosVigentes(CByte(dr("IdRol")), CBool(dr("ConsultaZonasEspecificas")), CBool(dr("ConsultaPlantelesEspecificos")), Session("Login"))
