...
Partial Class Consulta_PlantelHrsTipoNominaEmps
    ...
    Private Sub BindgvPlantel(pIdPlantel As Short)
        ...
        gvPlantel.DataBind()
    End Sub
    Private Sub BindgvNombramiento(pAbrevTipoNomina As String)
        Dim oNomina As New TipoDeNomina

        If pAbrevTipoNomina <> "0" Then
            gvTipoNomina.DataSource = oNomina.ObtenTipoPorAbrev(pAbrevTipoNomina).Table
        Else
            gvTipoNomina.EmptyDataText = "Sin información de tipo de nómina"
        End If
    ...
    Private Sub BindgvEmpleados()
        ...
        Dim vlAbrevTipoNomina As String
        ...
        dtEmpleados = oPlantel.ObtenEmpsPorTipoNomina(CShort(Request.Params("IdPlantel")), CStr(Request.Params("AbrevTipoNomina")), CShort(drQna("IdQuincena")))
        '    dtEmpleados = oPlantel.ObtenEmpsPorTipoNomina(CShort(Request.Params("IdPlantel")), CStr(Request.Params("AbrevTipoNomina")))
        'Else
        'oQna.IdQuincena = CShort(Request.Params("IdQuincena"))
        'drQna = oQna.ObtenPorId(False).Rows(0)
        'lblInfRelQna.Text = "INFORMACIÓN RELACIONADA CON LA QUINCENA " + drQna("Quincena")
        'dtEmpleados = oPlantel.ObtenEmpsPorTipoNomina(CShort(Request.Params("IdPlantel")), CStr(Request.Params("AbrevTipoNomina")), CShort(Request.Params("IdQuincena")))
        'End If

        If dtEmpleados.Rows.Count > 0 Then
            vlAbrevTipoNomina = CStr(Request.Params("AbrevTipoNomina"))
            BindgvPlantel(CShort(Request.Params("IdPlantel")))
            BindgvNombramiento(vlAbrevTipoNomina)
        Else
            BindgvPlantel(0)
    ...
    Protected Sub btnExport_Click(sender As Object, e As System.EventArgs) Handles btnExport.Click
        ...
        'Response.AddHeader("Content-disposition", "filename=PlantelTipoNominaEmps.xls")
