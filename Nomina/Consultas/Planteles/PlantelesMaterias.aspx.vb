...
Partial Class Consulta_PlantelesMaterias
    ...
    Private Sub BindgvMaterias()
        ...
        dtMaterias = oPlantel.ObtenMaterias(CInt(Request.Params("IdHora")), CShort(drQna("IdQuincena")))
        'Else
    ...
    Protected Sub btnExport_Click(sender As Object, e As System.EventArgs) Handles btnExport.Click
        ...
        'Response.AddHeader("Content-disposition", "filename=PlantelMaterias.xls")
