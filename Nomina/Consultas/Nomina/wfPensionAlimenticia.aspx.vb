...
Partial Class wfMain_PensionAlim
    Inherits System.Web.UI.Page
    Private Sub ddlFormaCalculoSelectedIndexChanged()
        Select Case ddlFormaCalculo.SelectedValue
            Case 1 'Porcentaje
                chbxDescontarSoloEnQnasOrd.Enabled = False
                chbxDescontarSoloEnQnasOrd.Checked = False
                txtbxNumSalMin.Enabled = False
                txtbxNumSalMin_CV.Enabled = False
                txtbxNumSalMin_CV2.Enabled = False
                txtbxNumSalMin_RFV.Enabled = False
                txtbxNumSalMin.Text = "0.00"

                txtbxMontoFijo.Enabled = False
                txtbxMontoFijo_CV.Enabled = False
                txtbxMontoFijo_CV2.Enabled = False
                txtbxMontoFijo_RFV.Enabled = False
                txtbxMontoFijo.Text = "0.00"

                txtbxPorc.Enabled = True
                txtbxPorc_CV.Enabled = True
                txtbxPorc_RV.Enabled = True
                ddlBeneficiarios.Enabled = True
                RFVPorc.Enabled = True
                txtbxPorc_CV2.Enabled = True

            Case 2 'Salarios mínimos
                chbxDescontarSoloEnQnasOrd.Enabled = True
                txtbxNumSalMin.Enabled = True
                txtbxNumSalMin_CV.Enabled = True
                txtbxNumSalMin_CV2.Enabled = True
                txtbxNumSalMin_RFV.Enabled = True
                ...
                txtbxPorc_CV.Enabled = False
                txtbxPorc_RV.Enabled = False
                RFVPorc.Enabled = False
                txtbxPorc.Text = "0.00"
                ddlBeneficiarios.Enabled = False
                txtbxPorc_CV2.Enabled = False
            Case 3 'Monto fijo
                chbxDescontarSoloEnQnasOrd.Enabled = True
                ...
                txtbxMontoFijo.Enabled = True
                txtbxMontoFijo_CV.Enabled = True
                txtbxMontoFijo_CV2.Enabled = True
                txtbxMontoFijo_RFV.Enabled = True
    ...
    Private Sub GuardaInformacion(ByVal pTipoOperacion As String)
        Try
            ...
            With oEmp
                ...
                .Porcentaje = CDec(IIf(txtbxPorc.Text.Trim = "", "0.00", txtbxPorc.Text.Trim))

                .AplicarSoloEnQnasOrd = chbxDescontarSoloEnQnasOrd.Checked
                .IdFormaCalcPA = CByte(ddlFormaCalculo.SelectedValue)
                .NumDeSalMin = CDec(IIf(txtbxNumSalMin.Text.Trim = "", "0.00", txtbxNumSalMin.Text))
                .MontoFijo = CDec(IIf(txtbxMontoFijo.Text.Trim = "", "0.00", txtbxMontoFijo.Text))
                ...
                .IdBeneficiarioDivision = CShort(ddlBeneficiarios.SelectedValue)
    ...
    Private Sub MostraraDetallesRegistro(ByVal pIdBeneficiario As Short, ByVal pTipoOperacion As String, Optional pCopia As Boolean = False)
        ...
        ddlFormaCalculo.SelectedValue = drBenefPA("IdFormaCalcPA").ToString.Trim
        ...
        chbxDescontarSoloEnQnasOrd.Checked = CBool(drBenefPA("AplicarSoloEnQnasOrd"))
        txtbxNumSalMin.Text = drBenefPA("NumDeSalMin").ToString.Trim
        txtbxMontoFijo.Text = drBenefPA("MontoFijo").ToString.Trim

        ddlFormaCalculoSelectedIndexChanged()
    ...
    Private Sub setPermisos()
        ...
        gvPensionados2.Columns(13).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Consulta")) 'Permiso consulta para ver detalles
        gvPensionados2.Columns(14).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Insercion")) And vlHayQnaAbierta 'Permiso inserción
        gvPensionados.Columns(16).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Consulta")) 'Permiso consulta para ver detalles
        gvPensionados.Columns(17).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Actualizacion")) And vlHayQnaAbierta 'Permiso modificación
        gvPensionados.Columns(18).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Actualizacion")) And vlHayQnaAbierta 'Permiso baja
        gvPensionados.Columns(19).Visible = CBool(dtPermisosUsuario.Rows(0).Item("Eliminacion")) And vlHayQnaAbierta 'Permiso eliminación
    End Sub
    ...
    Private Sub BindlbBeneficiarios(Optional ByVal IdBeneficiarioDivision As String = Nothing, Optional ByVal IdBeneficiario As String = Nothing)
        ...
        If Not Session("RFCParaCons") Is Nothing Or hfNomEmp.Value.Trim <> String.Empty Then
            ...
            If IdBeneficiario Is Nothing = False Then ddlBeneficiarios.Items.Remove(ddlBeneficiarios.Items.FindByValue(IdBeneficiario))

            If IdBeneficiarioDivision Is Nothing = False Then
                Try
                    'lbBeneficiarios.SelectedValue = IdBeneficiarioDivision
                    ddlBeneficiarios.SelectedValue = IdBeneficiarioDivision
                Catch ex As Exception
                    'lbBeneficiarios.Items(0).Selected = True
                    ddlBeneficiarios.Items(0).Selected = True
                End Try
            Else
                'lbBeneficiarios.Items(0).Selected = True
                ddlBeneficiarios.Items(0).Selected = True
    ...
    Protected Sub lbAgregarNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbAgregarNuevo.Click
        ...
        MultiView1.SetActiveView(viewCapturaModif)
    End Sub
    ...
    Protected Sub ddlFormaCalculo_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlFormaCalculo.SelectedIndexChanged
        ddlFormaCalculoSelectedIndexChanged()
    End Sub
End Class
