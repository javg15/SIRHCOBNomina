...
Partial Class Reportes_Trimestrales
    ...
    Private Sub CreaLinkParaImpresion2(ByVal gvr As GridViewRow)
        ...
        Select Case lblIdReporte.Text
            Case "112" 'Reporte de costo trimestral de la plantilla COBAEV
                Me.ibExportarExcel.OnClientClick = "javascript:abreVentanaImpresion('../../VisorDeReportesExcel.aspx" _
                            + "?Anio=" + ddlAños.SelectedValue _
                            + "&Trimestre=" + ddlTrimestres.SelectedValue _
                            + "&IdReporte=" + lblIdReporte.Text + "','CostoPlantilla_" + ddlAños.SelectedValue + "_Trim_" + Me.ddlTrimestres.SelectedValue + "'); return false;"
        End Select
    End Sub
    ...
    Protected Sub ddlTrimestres_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlTrimestres.SelectedIndexChanged
        Dim gvr As GridViewRow = Me.gvReportes.SelectedRow
        CreaLinkParaImpresion(gvr)
    End Sub
End Class