<%@ Page Language="VB" EnableEventValidation="false" MasterPageFile="~/MasterPageSesionIniciada.master"
    AutoEventWireup="false" CodeFile="ReportesDeduccionesPorQna.aspx.vb" Inherits="ReportesDeduccionesPorQna"
    Title="COBAEV - Nómina - Reportes sobre terceros institucionales" StylesheetTheme="SkinFile" %>
