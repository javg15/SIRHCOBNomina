...
Imports System.Data
Partial Class MasterPageSesionIniciada
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Dim miScript3 As Literal = New Literal()
        ...
        miScript3.Text = "<script type='text/javascript' language='javascript' src='" + ResolveClientUrl("~/Scripts/jquery-1.4.1.min.js") + "'></script>"

        Page.Header.Controls.Add(miScript)
        Page.Header.Controls.Add(miScript2)
        Page.Header.Controls.Add(miScript3)
        ...
        If Not IsPostBack Then
            ...
            Dim sURLAnt As String = String.Empty
            Dim vlSegmento As Integer
            Session.Remove("URLAnt")
            ...
            If Not UsrTienePermiso Then 'oUsr.TienePermisoSobrePagina(Request.Url.Segments(Request.Url.Segments.Length - 1).ToString, CByte(Request.Params("TipoOperacion"))) Then
                Try
                    For vlSegmento = 2 To Request.UrlReferrer.Segments.Length - 1
                        sURLAnt = sURLAnt + Request.UrlReferrer.Segments(vlSegmento).ToString
                    Next

                    Session.Add("URLAnt", sURLAnt)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Page.User.Identity.IsAuthenticated Then
                ...
                LoginStatus1.LogoutText = "Cerrar sesión de: " + Session("Login").ToString.ToUpper
                LoginStatus1.ToolTip = "Cerrar sesión de: " + Session("Login").ToString.ToUpper
            ...
            End If
        End If
        'If dtNotif Is Nothing Then
        '    lnkbtnNotific.Text = "Notificaciones pendientes (0)"
        'Else
        Try
            lnkbtnNotific.Text = "Notificaciones pendientes (" + dtNotif.Rows.Count.ToString + ")"
        Catch
            lnkbtnNotific.Text = "Notificaciones pendientes (0)"
        End Try
        'End If
