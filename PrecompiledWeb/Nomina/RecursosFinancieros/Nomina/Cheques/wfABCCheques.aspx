<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="wfABCCheques, App_Web_xpfamm0l" title="COBAEV - Nómina - ABC Cheques" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
            ...
            <table style="width: 100%; vertical-align: top;" align="center">
                <tr>
                    <td style="vertical-align: top; text-align: right">
                        <h2>
                            Sistema de nómina: Consulta/Actualización de cheques quincenales/mensuales
                        </h2>
                    </td>
                </tr>
            </table>
            <asp:Panel ID="pnlTiposDeCheques" runat="server" Font-Names="Verdana" Font-Size="X-Small"
                GroupingText="Seleccione tipo de cheque" HorizontalAlign="Left">
