<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ViaticosPorEmp, App_Web_2z0leohb" title="COBAEV - Nómina - Viáticos (Nivel empleado)" stylesheettheme="SkinFile" enableeventvalidation="true" maintainScrollPositionOnPostBack="true" %>
            ...
            <table style="width: 100%;" align="center">
                <tr>
                    <td style="vertical-align: top; text-align: right">
                        <h2>
                            Sistema de nómina: Viáticos mensuales (Nivel empleado)
                        </h2>
                    </td>
                </tr>
            </table>
