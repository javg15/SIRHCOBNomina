<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="wfPagomatico, App_Web_hvbr2bml" title="COBAEV - Nómina - Reportes de pagomático" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Reportes (Dispersión electrónica bancaria)
                </h2>
            </td>
        </tr>
        <tr>
