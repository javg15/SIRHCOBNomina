<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="CompensacionesBuscarEmps, App_Web_1asgeb2l" title="COBAEV - Nómina - Gratificaciones Extraordinarias (Nivel empleado)" stylesheettheme="SkinFile" enableeventvalidation="true" maintainScrollPositionOnPostBack="true" %>
            ...
            <table style="width: 100%;" align="center">
                <tr>
                    <td style="vertical-align: top; text-align: right">
                        <h2>
                            Sistema de nómina: gratificaciones extraordinarias mensuales (Nivel empleado)
                        </h2>
                    </td>
                </tr>
            </table>
                ...
                <asp:View ID="VABCCompen" runat="server">
                    ...
                    <asp:Panel ID="pnl2" runat="server" GroupingText="" Visible="false" HorizontalAlign="Left">
                        <div style="text-align: right">
                            <asp:LinkButton ID="lbAddCompen" runat="server" CausesValidation="False">Asignar Gratificación Extraordinaria</asp:LinkButton>
                        </div>
                        <asp:GridView ID="gvHistoriaCompe" runat="server" AutoGenerateColumns="False" EmptyDataText="No existen Gratificación Extraordinaria para el empleado en el año indicado."
                        ...
                        <asp:Panel ID="pnl4" runat="server" GroupingText="" Visible="false" HorizontalAlign="Left">
                            <div style="text-align: right">
                                <asp:LinkButton ID="lbAddCompenBPA" runat="server" CausesValidation="False">Asignar Gratificación Extraordinaria (Pensión alimenticia)</asp:LinkButton>
                            </div>
                            <asp:GridView ID="gvHistoriaCompe2" runat="server" AutoGenerateColumns="False" EmptyDataText="No existen Gratificaciones extraordinarias relacionadas con el beneficiario en el año indicado."
                                SkinID="SkinGridView" ShowFooter="True" Width="100%">
                                <Columns>
                                    <asp:TemplateField HeaderText="Año">
                                        <ItemTemplate>
                        ...
                        <div class="accountInfo">
                            <fieldset id="fsCaptura">
                                ...
                                <div class="panelIzquierda">
                                    ...
                                    <p class="pLabel">
                                        <asp:Label ID="lblImporteCompen" runat="server" CssClass="pLabel" Text="Importe de la Gratificación Extraordinaria:">
                                        </asp:Label>
                                    </p>
                                    <p class="pTextBox">
