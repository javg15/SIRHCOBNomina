<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="EjercFiscSolicitudDeConstDeSdo, App_Web_bqz5ylsh" title="COBAEV - Nómina - Ejercicios Fiscales, Solicitud de constancias de sueldo" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Declaración anual (Registro de solicitud de constancias de sueldos)
                </h2>
            </td>
        </tr>
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlBusquedaDePersonas" runat="server" DefaultButton="btnBuscar">
                            ...
                            <br />
                            <asp:CheckBox ID="chbxSolicitoConstancia" runat="server" Enabled="False" SkinID="SkinCheckBox"
                                Text="Costancia solicitada para el ejercicio" Visible="False" />&nbsp;<asp:Button
                                    ID="btnModificar" runat="server" Enabled="False" OnClick="btnModificar_Click"
                                    SkinID="SkinBoton" Text="Modificar" Visible="False" />&nbsp;<asp:Button ID="btnGuardar"
                                        runat="server" Enabled="False" OnClick="btnGuardar_Click" SkinID="SkinBoton"
                                        Text="Guardar" Visible="False" /><ajaxToolkit:ConfirmButtonExtender ID="CBESubsidioParaEmpleo"
                                            runat="server" ConfirmText="¿Está seguro de realizar la operación?" TargetControlID="btnGuardar">
