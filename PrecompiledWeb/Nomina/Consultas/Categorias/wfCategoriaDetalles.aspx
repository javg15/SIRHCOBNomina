<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="wfCategoriaDetalles, App_Web_4tj0l1t0" title="COBAEV - Nómina - Categorías (Detalles)" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UPMain" runat="server">
        <ContentTemplate>
            <h2>
                Sistema de nómina: Categorías (Detalles)
            </h2>
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="viewDetalles" runat="server">
                <div class="accountInfo">
                    <asp:Panel ID="pnlWarning" CssClass="Warning1" runat="server" Visible="False">
                    ...
                    <p>
                        <asp:CheckBox ID="chbxMostrarOcultarTips" runat="server" AutoPostBack="True" 
                            Text="Mostrar ayuda en los campos a llenar" Visible="False" />
                    </p>
                    <fieldset id="fsCaptura">
                        ...
                        <div class="panelIzquierda">
                            ...
                            <p class="pTextBox">
                                <asp:TextBox ID="txtbxRFC" runat="server" MaxLength="13" CssClass="textEntry" 
                                ...
                                <p  class="pLabel">
                                    <asp:Label ID="lblApePat" runat="server" CssClass="pLabel" 
                                        Text="Apellido paterno:" />
                                </p>
                                <p class="pTextBox">
                                    <asp:TextBox ID="txtbxApePat" runat="server" AutoPostBack="True" 
                                        CssClass="textEntry" MaxLength="30" TabIndex="3"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RFVApePatEmp" runat="server" 
                                        ControlToValidate="txtbxApePat" Display="Dynamic" ErrorMessage="*" 
                                        ToolTip="La captura del Apellido Paterno es obligatoria." 
                                        ValidationGroup="GrupoGuardar">
                                    </asp:RequiredFieldValidator>
                                    <ajaxToolkit:AutoCompleteExtender ID="ACEApellidosP" runat="server" 
                                        BehaviorID="AutoCompleteAP" EnableCaching="true" MinimumPrefixLength="2" 
                                        ServiceMethod="BuscarApellidos" ServicePath="~/WSBusquedas.asmx" 
                                        TargetControlID="txtbxApePat">
                                    </ajaxToolkit:AutoCompleteExtender>
                                    <ajaxToolkit:FilteredTextBoxExtender ID="FTBEApellidosP" runat="server" 
                                        FilterType="Custom, UppercaseLetters, LowercaseLetters" 
                                        TargetControlID="txtbxApePat" ValidChars=" ÑñÁáÉéÍíÓóÚó-">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                                    <ajaxToolkit:BalloonPopupExtender ID="txtbxApePat_BPE" runat="server" 
                                        BalloonPopupControlID="pnlHelpApePat" BalloonSize="Medium" CustomCssUrl="" 
                                        DynamicServicePath="" Enabled="True" ExtenderControlID="txtbxApePat" 
                                    ...
                                    <p class="pTextBox">
                                        <asp:TextBox ID="txtbxNombre" runat="server" AutoPostBack="True" 
                                            CssClass="textEntry" MaxLength="30" TabIndex="5"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="txtbxNombre_RFV" runat="server" 
                                            ControlToValidate="txtbxNombre" Display="Dynamic" ErrorMessage="*" 
                                            ToolTip="La captura del Nombre es obligatoria." ValidationGroup="GrupoGuardar">
                                            </asp:RequiredFieldValidator>
                                        <ajaxToolkit:AutoCompleteExtender ID="txtbxNombre_ACE" runat="server" 
                                            EnableCaching="true" MinimumPrefixLength="2" ServiceMethod="BuscarNombres" 
                                            ServicePath="~/WSBusquedas.asmx" TargetControlID="txtbxNombre">
                                        </ajaxToolkit:AutoCompleteExtender>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtbxNombre_FTBE" runat="server" 
                                            FilterType="Custom, UppercaseLetters, LowercaseLetters" 
                                            TargetControlID="txtbxNombre" ValidChars=" ÑñÁáÉéÍíÓóÚó-">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxNombre_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelpNombre" BalloonSize="Medium" CustomCssUrl="" 
                                            DynamicServicePath="" Enabled="True" ExtenderControlID="txtbxNombre" 
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlSexos" runat="server" AutoPostBack="True" 
                                                 CssClass="textEntry"
                                            ...
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlSexos_BPE" runat="server" 
                                                CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="ddlSexos" 
                                                TargetControlID="ddlSexos" BalloonPopupControlID="pnlHelpSexos" 
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlParentescos" runat="server"  CssClass="textEntry" 
                                                TabIndex="8">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="ddlParentescos_RFV" runat="server" ControlToValidate="ddlParentescos"
                                                Display="Dynamic" ErrorMessage="*" ToolTip="Seleccionar el parentesco del beneficiario es obligatorio." InitialValue="7" ValidationGroup="GrupoGuardar">
                                                </asp:RequiredFieldValidator>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlParentescos_BPE" runat="server" 
                                                CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="ddlParentescos" 
                                                TargetControlID="ddlParentescos" BalloonPopupControlID="pnlHelpParentesco" 
                                                DisplayOnFocus="True" BalloonSize="Medium">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                        <p class="pLabel">
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlPrioridadCalculo" runat="server" CssClass="textEntry" 
                                                TabIndex="10" Visible="False">
                                            </asp:DropDownList>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlPrioridadCalculo_BPE" runat="server" 
                                                CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="ddlPrioridadCalculo" 
                                                TargetControlID="ddlPrioridadCalculo" BalloonSize="Medium"
                                                BalloonPopupControlID="pnlHelpPrioridadCalculo" DisplayOnFocus="True">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                     <p  class="pLabel">
                                     </p>
                                    <p class="pListBox">
                                        ...
                                        <p class="pTextBox">
                                            <asp:CheckBox runat="server" ID="chkbxTransBanc" 
                                                Text="Pagar mediante transferencia bancaria" TabIndex="13" 
                                                AutoPostBack="True"/>
                                        </p>
                                        <p  class="pLabel">
                                        ...
                                        <p class="pTextBox">
                                                ...
                                                <asp:RequiredFieldValidator ID="ddlBancosTB_RFV" runat="server" 
                                                    ControlToValidate="ddlBancosTB" Display="Dynamic" ErrorMessage="*" 
                                            ...
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlBancosTB_BPE" runat="server" 
                                                BalloonPopupControlID="pnlHelpBancosTB" BalloonSize="Medium" CustomCssUrl="" 
                                                DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                                ExtenderControlID="ddlBancosTB" TargetControlID="ddlBancosTB">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                         <p  class="pLabel">
                                    ...
                                    <p class="pTextBox">
                                        <asp:TextBox ID="txtbxCtaBancTB" runat="server" CssClass="textEntry" 
                                            TabIndex="17" ValidationGroup="GrupoGuardar"></asp:TextBox>
                                        ...
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxCtaBancTB_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelpCtaBancTB" BalloonSize="Medium" CustomCssUrl="" 
                                            DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                            ExtenderControlID="txtbxCtaBancTB" TargetControlID="txtbxCtaBancTB">
                                        </ajaxToolkit:BalloonPopupExtender>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtbxCtaBancTB_FTE" runat="server" 
                                            FilterType="Numbers" TargetControlID="txtbxCtaBancTB" ValidChars="">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="txtbxCtaBancTB_RFV" runat="server" 
                                            ControlToValidate="txtbxCtaBancTB" Display="Dynamic" ErrorMessage="*" 
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlPlanteles" runat="server" CssClass="textEntry" 
                                                TabIndex="19">
                                            </asp:DropDownList>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlPlanteles_BPE" runat="server" 
                                                CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="ddlPlanteles" 
                                                TargetControlID="ddlPlanteles" BalloonPopupControlID="pnlHelpPlanteles" 
                                                BalloonSize="Medium" DisplayOnFocus="True">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                        <p>
                                        </p>
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlQnaIni" runat="server" AutoPostBack="true" 
                                                CssClass="textEntry" TabIndex="21">
                                            </asp:DropDownList>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlQnaIni_BPE" runat="server" 
                                                BalloonPopupControlID="pnlHelpQnaIni" BalloonSize="Medium" CustomCssUrl="" 
                                                DisplayOnFocus="true" DynamicServicePath="" Enabled="True" 
                                                ExtenderControlID="ddlQnaIni" TargetControlID="ddlQnaIni">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                        <p>
                                        </p>
                        ...
                        <div class="pnlDerecha">
                            ...
                            <p class="pTextBox">
                                <asp:TextBox ID="txtbxCURP" runat="server" MaxLength="18" CssClass="textEntry" 
                                ...
                                <p  class="pLabel">
                                    <asp:Label ID="lblApeMat" runat="server" CssClass="pLabel" 
                                        Text="Apellido materno:" />
                                </p>
                                <p class="pTextBox">
                                    <asp:TextBox ID="txtbxApeMat" runat="server" AutoPostBack="True" 
                                        CssClass="textEntry" MaxLength="30" TabIndex="4"></asp:TextBox>
                                    <ajaxToolkit:AutoCompleteExtender ID="txtbxApeMat_ACE" runat="server" 
                                        BehaviorID="AutoCompleteAM" EnableCaching="true" MinimumPrefixLength="2" 
                                        ServiceMethod="BuscarApellidos" ServicePath="~/WSBusquedas.asmx" 
                                        TargetControlID="txtbxApeMat">
                                    </ajaxToolkit:AutoCompleteExtender>
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtbxApeMat_FTBE" runat="server" 
                                        FilterType="Custom, UppercaseLetters, LowercaseLetters" 
                                        TargetControlID="txtbxApeMat" ValidChars=" ÑñÁáÉéÍíÓóÚó-">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                                    <ajaxToolkit:BalloonPopupExtender ID="txtbxApeMat_BPE" runat="server" 
                                        BalloonPopupControlID="pnlHelpApeMat" BalloonSize="Medium" CustomCssUrl="" 
                                        DynamicServicePath="" Enabled="True" ExtenderControlID="txtbxApeMat" 
                                    ...
                                    <p  class="pLabel">
                                        <asp:Label ID="lblFechaNac" runat="server" CssClass="pLabel" 
                                            Text="Fecha de nacimiento:" />
                                    </p>
                                    <p class="pTextBox">
                                        <asp:TextBox ID="txtbxFecNac" runat="server" CssClass="textEntry" 
                                            MaxLength="10" Wrap="False" TabIndex="7"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="txtbxFecNac_CE" runat="server" Enabled="True" 
                                            TargetControlID="txtbxFecNac">
                                        </ajaxToolkit:CalendarExtender>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxFecNac_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelpFechNac" CustomCssUrl="" DynamicServicePath="" 
                                            Enabled="True" ExtenderControlID="txtbxFecNac"  BalloonSize="Medium"
                                            TargetControlID="txtbxFecNac" DisplayOnFocus="True">
                                        </ajaxToolkit:BalloonPopupExtender>
                                        <asp:CompareValidator ID="txtbxFecNac_CV" runat="server" 
                                            ControlToValidate="txtbxFecNac" Display="Dynamic" ErrorMessage="*" 
                                            Operator="DataTypeCheck" ToolTip="Fecha incorrecta" Type="Date" 
                                            ValidationGroup="GrupoGuardar">
                                             </asp:CompareValidator>
                                        </p>
                                        <p class="pLabel">
                                            <asp:Label ID="lblEdoNac" runat="server" CssClass="pLabel" 
                                                Text="Estado natal del beneficiario:" />
                                        </p>
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlEstados" runat="server" CssClass="textEntry" 
                                                TabIndex="9">
                                            </asp:DropDownList>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlEstados_BPE" runat="server" 
                                                BalloonPopupControlID="pnlHelpEdoNatal" BalloonSize="Medium" CustomCssUrl="" 
                                                DynamicServicePath="" Enabled="True" ExtenderControlID="ddlEstados" 
                                                TargetControlID="ddlEstados" DisplayOnFocus="True">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                     <p  class="pLabel">
                                         <asp:Label ID="lblPorc" runat="server" CssClass="pLabel" 
                                             Text="Porcentaje asignado:" />
                                    </p>
                                    <p class="pTextBox">
                                        <asp:TextBox ID="txtbxPorc" runat="server" CssClass="textEntry" MaxLength="5" 
                                            TabIndex="11" ValidationGroup="GrupoGuardar"></asp:TextBox>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxPorc_BPE" 
                                            runat="server" BalloonPopupControlID="pnlHelpPorcentaje" BalloonSize="Medium" 
                                            CustomCssUrl="" DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                            ExtenderControlID="txtbxPorc" TargetControlID="txtbxPorc">
                                        </ajaxToolkit:BalloonPopupExtender>
                                        ...
                                        <asp:CompareValidator ID="txtbxPorc_CV" runat="server" 
                                            ControlToValidate="txtbxPorc" Display="Dynamic" ErrorMessage="*" 
                                            Operator="DataTypeCheck" 
                                            ToolTip="El valor capturado para el porcentaje es incorrecto." Type="Double" 
                                            ValidationGroup="GrupoGuardar">
                                            </asp:CompareValidator>
                                        <asp:RequiredFieldValidator ID="RFVPorc" runat="server" 
                                            ControlToValidate="txtbxPorc" Display="Dynamic" ErrorMessage="*" 
                                            ToolTip="La captura del porcentaje es obligatoria." 
                                            ValidationGroup="GrupoGuardar">
                                            </asp:RequiredFieldValidator>
                                     ...
                                     <p  class="pLabel">
                                         <asp:Label ID="lblPorcCompartidoCon" runat="server" CssClass="pLabel" 
                                             Text="Porcentaje se obtendrá del:" />
                                    </p>
                                    <p class="pListBox">

                                        <asp:ListBox ID="lbBeneficiarios" runat="server" Height="100%" TabIndex="12">
                                        </asp:ListBox>
                                        <ajaxToolkit:BalloonPopupExtender ID="lbBeneficiarios_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelplbBeneficiarios"
                                            BalloonSize="Medium" CustomCssUrl="" DisplayOnFocus="True" DynamicServicePath=""
                                            Enabled="True" ExtenderControlID="lbBeneficiarios" TargetControlID="lbBeneficiarios">
                                        </ajaxToolkit:BalloonPopupExtender>
                                    </p>
                                        <p class="pLabel">
                                        </p>
                                        <p class="pTextBox">
                                            <asp:CheckBox runat="server" ID="chkbxTransInterBanc" 
                                                Text="Pagar mediante transferencia interbancaria (CLABE)" TabIndex="14" 
                                                AutoPostBack="True"/>
                                        </p>
                                         <p class="pLabel">
                                    ...
                                    <p class="pTextBox">
                                        <asp:TextBox ID="txtbxCtaTIB" runat="server" CssClass="textEntry" 
                                            TabIndex="16" ValidationGroup="GrupoGuardar" AutoPostBack="True" 
                                            ...
                                            <asp:RegularExpressionValidator ID="txtbxCtaTIB_REV" runat="server" ValidationExpression="\d{18}"
                                                ...
                                                ValidationGroup="GrupoGuardar"></asp:RegularExpressionValidator>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxCtaTIB_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelpCtaTIB" BalloonSize="Medium" CustomCssUrl="" 
                                            DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                            ExtenderControlID="txtbxCtaTIB" TargetControlID="txtbxCtaTIB">
                                        </ajaxToolkit:BalloonPopupExtender>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtbxCtaTIB_FTE" runat="server" 
                                            FilterType="Numbers" TargetControlID="txtbxCtaTIB" ValidChars="">
                                        </ajaxToolkit:FilteredTextBoxExtender>
                                        <asp:RequiredFieldValidator ID="txtbxCtaTIB_RFV" runat="server" 
                                            ControlToValidate="txtbxCtaTIB" Display="Dynamic" ErrorMessage="*" 
                                            ToolTip="La captura de la cuenta para la transferencia interbancaria es obligatoria."
                                            ValidationGroup="GrupoGuardar"></asp:RequiredFieldValidator>
                                    </p>
                                        <p class="pLabel">
                                        ...
                                        <p class="pTextBox">
                                                ...
                                                <asp:RequiredFieldValidator ID="ddlBancosTIB_RFV" runat="server" 
                                                    ControlToValidate="ddlBancosTIB" Display="Dynamic" ErrorMessage="*" 
                                                    InitialValue="4" ToolTip="El banco para la transferencia interbancaria es incorrecto." 
                                                    ValidationGroup="GrupoGuardar" Enabled="false">
                                            </asp:RequiredFieldValidator>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlBancosTIB_BPE" runat="server" 
                                                BalloonPopupControlID="pnlHelpBancosTIB" BalloonSize="Medium" CustomCssUrl="" 
                                                DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                                ExtenderControlID="ddlBancosTIB" TargetControlID="ddlBancosTIB">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                        <p  class="pLabel">
                                        ...
                                        <p class="pTextBox">
                                                <asp:DropDownList ID="ddlBancosParaDispersion" runat="server" 
                                                    CssClass="textEntry" Enabled="false"
                                                    TabIndex="20" AutoPostBack="True">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="ddlBancosParaDispersion_RFV" runat="server" 
                                                    ControlToValidate="ddlBancosParaDispersion" Display="Dynamic" ErrorMessage="*" 
                                                    InitialValue="3" ToolTip="Seleccionar el banco a través del cual se realizará la dispersión es obligatorio." 
                                                    ValidationGroup="GrupoGuardar" Enabled="false">
                                            </asp:RequiredFieldValidator>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlBancosParaDispersion_BPE" runat="server" 
                                                ...
                                                DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                                ExtenderControlID="ddlBancosParaDispersion" TargetControlID="ddlBancosParaDispersion">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                                        <p class="pLabel">
                                        ...
                                        <p class="pTextBox">
                                            <asp:DropDownList ID="ddlQnaFin" runat="server" CssClass="textEntry" 
                                                TabIndex="22">
                                            </asp:DropDownList>
                                            <ajaxToolkit:BalloonPopupExtender ID="ddlQnaFin_BPE" runat="server" 
                                                CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="ddlQnaFin" 
                                                TargetControlID="ddlQnaFin" BalloonPopupControlID="pnlHelpQnaFin" 
                                                BalloonSize="Medium" DisplayOnFocus="True">
                                            </ajaxToolkit:BalloonPopupExtender>
                                        </p>
                        </div>
                        <fieldset id="fsCapturaDatosDemanda" style="width: 97%; float:left;">
                            <legend class="sublegend">
                                <asp:Label ID="lblDatosDemanda" Text="Datos del dictamen de pensión aliementicia" runat="server" Font-Strikeout="False" Font-Underline="True">
                                </asp:Label>
                            </legend>
                            <div class="panelIzquierda">
                                <p class="pLabel">
                                ...
                                <p class="pTextBox">
                                        <asp:TextBox ID="txtbxOficioDictamenPA" runat="server" MaxLength="50" CssClass="textEntry" 
                                            AutoPostBack="True" TabIndex="2"></asp:TextBox>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxOficioDictamenPA_BPE" runat="server" 
                                            BalloonPopupControlID="pnlHelpOficioDictamenPA"
                            ...
                            <div class="pnlDerecha">
                                ...
                                <p class="pTextBox">
                                        <asp:TextBox ID="txtbxExpedienteDictamenPA" runat="server" MaxLength="50" CssClass="textEntry" 
                                            AutoPostBack="True" TabIndex="2"></asp:TextBox>
                                        <ajaxToolkit:BalloonPopupExtender ID="txtbxExpedienteDictamenPA_BPE" runat="server" BalloonPopupControlID="pnlHelpExpedienteDictamenPA"
                                            CustomCssUrl="" DynamicServicePath="" Enabled="True" ExtenderControlID="txtbxExpedienteDictamenPA"
                                            TargetControlID="txtbxExpedienteDictamenPA" DisplayOnFocus="True" BalloonSize="Medium">
                                        </ajaxToolkit:BalloonPopupExtender>
                                    </p>
                            </div>
                        </fieldset>
