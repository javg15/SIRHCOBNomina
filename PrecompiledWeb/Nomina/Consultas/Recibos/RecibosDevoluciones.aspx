<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Consultas_RecibosDevoluciones, App_Web_n4f25cef" title="COBAEV - Nómina - Devoluciones de Recibos" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; height: 300px" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Recibos de pago fuera de nómina (Devoluciones)
                </h2>
            </td>
        </tr
        <tr>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                            <ContentTemplate>
                                                                <asp:GridView ID="gvRecibos" runat="server" Width="100%" SkinID="SkinGridView" EmptyDataText="No existen recibos capturados"
                                                                    AutoGenerateColumns="False" OnRowCommand="gvRecibos_RowCommand" OnRowDataBound="gvRecibos_RowDataBound"
                                                                    PageSize="1">
                                                                    <Columns>
