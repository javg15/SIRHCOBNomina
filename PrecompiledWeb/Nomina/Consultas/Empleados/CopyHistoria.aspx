<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="CopyHistoriaPlazas, App_Web_00vntztu" title="COBAEV - Nómina - Empleados (Historia ocupación de plazas)" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <asp:UpdatePanel ID="UPMain" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnl1" runat="server" HorizontalAlign="Left">
                <asp:Panel ID="pnlLinkCapturaMovs" runat="server" HorizontalAlign="Left">
                    <asp:LinkButton ID="lbCapturaMovs" runat="server" SkinID="SkinLinkButton">Captura de movimiento de personal al empleado</asp:LinkButton>
                </asp:Panel>
                ...
                <asp:Panel ID="TitlePanelPlazasBase" runat="server" BorderColor="White" BorderStyle="Solid"
                    ...
                    <asp:Label ID="lblMsjTitlePanel" runat="server">Plazas base del empleado</asp:Label>
                    <asp:Label ID="lbl1PlazasBase" runat="server">(Mostrar detalles...)</asp:Label>
                </asp:Panel>
                <asp:Panel ID="ContentPanelPlazasBase" runat="server" CssClass="collapsePanel" Width="100%">
                    <asp:GridView ID="gvPlazasBase" runat="server" EmptyDataText="El empleado no tiene registradas plazas base"
                        Height="100%" ShowFooter="True" SkinID="SkinGridViewEmpty" Width="100%" AutoGenerateColumns="False">
                        <Columns>
                            <asp:TemplateField HeaderText="Plazas Base">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label ID="lblCvePlazaTipo" runat="server" Text='<%# Bind("CvePlazaTipo") %>'
                                        ToolTip='<%# Bind("ToolTipPlazaTipo") %>'></asp:Label>
                                    ...
                                    <asp:Label ID="lblCvePlazaDiferenciador" runat="server" Text='<%# Bind("CvePlazaDiferenciador") %>'
                                        ToolTip='<%# Bind("ToolTipPlazaDiferenciador") %>'></asp:Label>
                                    <asp:Label ID="lblGuion3" runat="server" Text="-"></asp:Label>
                                    <asp:Label ID="lblCveCategoCOBACH" runat="server" Text='<%# Bind("CveCategoCOBACH") %>'
                                        ToolTip='<%# Bind("ToolTipCatego") %>'></asp:Label>
                                    <asp:Label ID="lblGuion4" runat="server" Text="-"></asp:Label>
                                    <asp:Label ID="lblstrHrsJornada" runat="server" Text='<%# Bind("strHrsJornada") %>'
                                        ToolTip="Horas asociadas a la plaza"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="RFC (Ocupante)">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkbtnrfc" runat="server" CommandName="CmdRFC" Text='<%# databinder.eval(container, "dataitem.RFCEmpOcup") %>'
                                        ToolTip="Click en el RFC para seleccionar al empleado para aplicarle operaciones."></asp:LinkButton>
                            ...
                            <asp:TemplateField HeaderText="Plantel (Adscrip. real)">
                                <ItemTemplate>
                                    <asp:Label ID="lblClavePlantelAdscripReal" runat="server" Text='<%# Bind("ClavePlantelAdscripReal") %>'
                                        ToolTip='<%# Bind("DescPlantelAdscripReal") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Esquema de pago">
                                <ItemTemplate>
                                    <asp:Label ID="lblEsquemaPago" runat="server" Text='<%# Bind("AbrevEsquemaPago") %>'
                                        ToolTip='<%# Bind("DescEsquemaPago") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
