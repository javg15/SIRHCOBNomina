<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="wfHistoriaPlazasPorEmp, App_Web_00vntztu" title="COBAEV - Nómina - Historia empleado" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                                                    ...
                                                    <asp:Panel ID="ContentPanelPlazasVigentes" runat="server" CssClass="collapsePanel"
                                                        ...
                                                        <asp:GridView ID="gvPlazasVigentes" runat="server" EmptyDataText="Sin plazas vigentes"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Inicio" HeaderText="Qna. inicio">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="" HeaderText="Fecha inicio"  DataFormatString="{0:d}">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="T&#233;rmino" HeaderText="Qna. fin">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="" HeaderText="Fecha fin" DataFormatString="{0:d}">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
