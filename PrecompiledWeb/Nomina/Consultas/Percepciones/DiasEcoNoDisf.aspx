<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Consultas_Percepciones_DiasEcoNoDisf, App_Web_nszpy5ff" title="COBAEV - Nómina - Días Económicos No Disfrutados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <tr>
        <td style="text-align: left; width: 100%;" colspan="2">
            <h2>
                Sistema de nómina: Solicitudes de Días Económicos No Disfrutados
            </h2>
        </td>
    </tr>
        <tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="pnlQuincenas" runat="server" DefaultButton="btnConsultarEmps" Font-Names="Verdana"
                                        Font-Size="X-Small" 
                                        GroupingText="Consulta de solicitudes por Año">
                                        <br />
        ...
        (Mostrar detalles...)</asp:Label>
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; width: 100%; text-align: left" colspan="2">
                                                    <asp:Panel ID="ContentPanelEstPuntYAsist" runat="server" Width="100%" CssClass="collapsePanel">
                                                        <asp:GridView ID="gvDiasEcoNoDisf" runat="server" Width="100%" SkinID="SkinGridView"
                                ...
                                <Triggers>
                                    ...
                                    <asp:AsyncPostBackTrigger ControlID="gvDiasEcoNoDisf" EventName="RowCommand" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
