<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="PercsDeducsParaCalcDeDeduc, App_Web_ekwo5m5f" title="COBAEV - Nómina - Percepciones/Deducciones para cálculo de Deducción" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
            ...
            <table style="width: 100%" align="center">
                <tr>
                    <td style="vertical-align: top; text-align: right" colspan="2">
                        <h2>
                            Sistema de nómina: Percepciones/Deducciones para cálculo de Deducción
                        </h2>
                    </td>
                </tr>
                <tr>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibQuitarPerc" runat="server" ImageUrl="~/Imagenes/Eliminar.png"
                                            OnClick="ibQuitarPerc_Click" ToolTip="Quitar percepción para que no participe en el cálculo de la deducción seleccionada." />
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibQuitarDeduc" runat="server" 
                                            ...
                                            ToolTip="Quitar deducción para que no participe en el cálculo de la deducción seleccionada." />
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibAddPerc" runat="server" ImageUrl="~/Imagenes/Add2.png" 
                                            ...
                                            ToolTip="Agregar percepción para que participe en el cálculo de la deducción seleccionada." />
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibAddDeduc" runat="server" ImageUrl="~/Imagenes/Add2.png"
                                            OnClick="ibAddDeduc_Click" ToolTip="Agregar deducción para que participe en el cálculo de la deducción seleccionada." />
