<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="InconsistenciasSobrePlazas, App_Web_flakjmxh" title="COBAEV - Nómina - Inconsistencias en plazas" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Empleados (Inconsistencias basadas en sus plazas)
                </h2>
            </td>
        </tr>
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvInconsistencias" runat="server" AutoGenerateColumns="False" CaptionAlign="Left"
                            ...
                            Width="100%" OnSelectedIndexChanged="gvInconsistencias_SelectedIndexChanged">
                            <Columns>
