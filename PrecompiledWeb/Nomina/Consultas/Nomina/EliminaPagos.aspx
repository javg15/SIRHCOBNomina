<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Consultas_Nomina_EliminaPagos, App_Web_xh1ifbg5" title="COBAEV - Nómina - Eliminar pagos de empleados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>

<%@ Register Src="~/WebControls/wucSearchEmps.ascx" TagName="wucBuscaEmpleados" TagPrefix="uc1" %>
<%@ Register Src="~/WebControls/wucUpdateProgress.ascx" TagName="wucUpdateProgress" TagPrefix="TP_wucUpdateProgress" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <TP_wucUpdateProgress:wucUpdateProgress ID="wucUpdateProgress1" runat="server" EnableViewState="true" />
    <table style="width: 100%; background-position: center center; background-repeat: no-repeat;
        height: 300px;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Empleados (Eliminar pagos quincenales)
                </h2>
            </td>
        </tr>
        <tr>
                                    ...
                                    <asp:Panel ID="pnl1" runat="server">
                                        ...
                                        <asp:Panel ID="pnlQuincenas" runat="server" Font-Size="X-Small" Font-Names="Verdana"
                                            ...
                                            <asp:Button ID="btnConsultarPago" OnClick="btnConsultarPago_Click" runat="server"
                                                SkinID="SkinBoton" Text="Consultar pago"></asp:Button>&nbsp;<asp:Button ID="btnEliminar"
                                                    runat="server" OnClick="btnEliminar_Click" SkinID="SkinBoton" Text="Eliminar pago" />
                                            <asp:Button ID="btnEliminarQnaCompleta" runat="server" OnClick="btnEliminarQnaCompleta_Click"
                                                SkinID="SkinBoton" Text="Eliminar quincena completa" />
                                            <ajaxToolkit:ConfirmButtonExtender ID="CBEbtnEliminar" runat="server" ConfirmText="¿Está seguro de eliminar el pago?"
                                                TargetControlID="btnEliminar">
                                            </ajaxToolkit:ConfirmButtonExtender>
                                            <ajaxToolkit:ConfirmButtonExtender ID="CBEEliminarQnaCompleta" runat="server" ConfirmText="¿Está seguro de eliminar la quincena completa?"
                                                TargetControlID="btnEliminarQnaCompleta">
                                            </ajaxToolkit:ConfirmButtonExtender>
                                            <br />
                                            <br />
                                        </asp:Panel>
