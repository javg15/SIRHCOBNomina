<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="wfMain_PensionAlim, App_Web_xh1ifbg5" title="COBAEV - Nómina - Consulta de beneficiarios de pensión alimenticia" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                    ...
                    <asp:Panel ID="pnlBenefPAVig" runat="server" Visible="false" GroupingText="Beneficiarios de pensión alimenticia (VIGENTES)">
                        <asp:GridView ID="gvPensionados" runat="server" EmptyDataText="Sin información de beneficarios de pensión alimenticia vigentes"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="strMontoFijo" HeaderText="Monto fijo a descontar:">
                ...
                <div class="accountInfo">
                    ...
                    <fieldset id="fsCapturaDatosPersBenef">
                        ...
                        <fieldset id="fsCapturaDatosFormaCalc" style="width: 97%; float: left;">
                            ...
                            <div class="panelIzquierda">
                                ...
                                <p class="pTextBox">
                                    <asp:DropDownList ID="ddlFormaCalculo" runat="server" CssClass="textEntry" AutoPostBack="True">
                                        ...
                                        <asp:ListItem Value="3">EN BASE A MONTO FIJO</asp:ListItem>
                                    </asp:DropDownList>
                                </p>
                                <p class="pLabel">
                            ...
                            <div class="pnlDerecha">
                                ...
                                <p class="pTextBox">
                                    <asp:CheckBox runat="server" ID="chbxDescontarSoloEnQnasOrd" 
                                        Text="Aplicar pensión alimenticia solo en quincenas ordinarias" />
                                </p>
                                <p class="pLabel">
                                ...
                                <p class="pLabel">
                                    <asp:Label ID="lblMontoFijo" runat="server" CssClass="pLabel" Text="Importe fijo a descontar:" />
                                </p>
                               <p class="pTextBox">
                                    <asp:TextBox ID="txtbxMontoFijo" runat="server" CssClass="textEntry" MaxLength="5"
                                        TabIndex="11" ValidationGroup="GrupoGuardar"></asp:TextBox>
                                    <ajaxToolkit:BalloonPopupExtender ID="txtbxMontoFijo_BPE" 
                                       runat="server" BalloonPopupControlID="pnlHelpMontoFijo" BalloonSize="Medium" 
                                       CustomCssUrl="" DisplayOnFocus="True" DynamicServicePath="" Enabled="True" 
                                       ExtenderControlID="txtbxMontoFijo" TargetControlID="txtbxMontoFijo">
                                    </ajaxToolkit:BalloonPopupExtender>
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtbxMontoFijo_FTBE" 
                                       runat="server" FilterType="Custom, Numbers" TargetControlID="txtbxMontoFijo" 
                                       ValidChars=".">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                                    <asp:CompareValidator ID="txtbxMontoFijo_CV" runat="server" ControlToValidate="txtbxMontoFijo"
                                        Display="Dynamic" ErrorMessage="*" Operator="DataTypeCheck" 
                                        ToolTip="El valor capturado para el importe fijo a descontar es incorrecto."
                                        Type="Double" ValidationGroup="GrupoGuardar">
                                    </asp:CompareValidator>
                                    <asp:CompareValidator ID="txtbxMontoFijo_CV2" runat="server" ControlToValidate="txtbxMontoFijo"
                                        Display="Dynamic" ErrorMessage="*" Operator="GreaterThanEqual" ToolTip="El valor capturado para el importe fijo a descontar debe ser mayor o igual a 0.50"
                                        Type="Double" ValidationGroup="GrupoGuardar" ValueToCompare="0.50">
                                    </asp:CompareValidator>
                                    <asp:RequiredFieldValidator ID="txtbxMontoFijo_RFV" runat="server" ControlToValidate="txtbxMontoFijo"
                                        Display="Dynamic" ErrorMessage="*" ToolTip="La captura del importe fijo a descontar es obligatoria."
                                        ValidationGroup="GrupoGuardar">
                                    </asp:RequiredFieldValidator>
                               </p>
                            </div>
                    ...
                    <div>
                        ...
                        <asp:Panel ID="pnlHelpParentesco" runat="server" HorizontalAlign="Justify">
                         ...
                         <asp:Panel ID="pnlHelpMontoFijo" runat="server" HorizontalAlign="Justify">
                            <p>
                                Dato obligatorio.
                            </p>
                            <p>
                                El importe del monto fijo debe ser mayor o igual de 0.5
                            </p>
                        </asp:Panel>  
