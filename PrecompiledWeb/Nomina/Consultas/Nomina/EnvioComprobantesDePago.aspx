<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="EnvioComprobantesDePago, App_Web_xh1ifbg5" title="COBAEV - Nómina - Impresión de nóminas" stylesheettheme="SkinFile" async="true" maintainScrollPositionOnPostBack="true" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlMeses" runat="server" Font-Names="Verdana" Font-Size="X-Small"
                            GroupingText="Meses pagados durante el año" Visible="False">
                            <br />
                ...
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="Label2" runat="server" SkinID="SkinLblNormal" Visible="False">Seleccione reporte</asp:Label>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:GridView ID="gvReportes" runat="server" AutoGenerateColumns="False"
                                        SkinID="SkinGridViewEmpty" Visible="False">
                                        <Columns>
                            ...
                            <tr>
                                <td>
                                    <asp:ImageButton ID="ibImprimir" runat="server" ImageUrl="~/Imagenes/GeneraReciboPDF.jpg"
                                        ToolTip="Generar comprobantes de pago" ValidationGroup="Grp1" />
                                    <ajaxToolkit:ConfirmButtonExtender ID="ibImprimir_CBE" runat="server" 
                                        ConfirmText="Esta operación podría durar varios minutos, ¿Desea continuar?" 
                                        Enabled="True" TargetControlID="ibImprimir">
                                    </ajaxToolkit:ConfirmButtonExtender>
                                    <asp:ImageButton ID="ibExportarExcel" runat="server" ImageUrl="~/Imagenes/ExcelExport.jpg"
                                        ToolTip="Mostrar reporte en Excel" Visible="False" style="width: 50px" />
                                    <asp:ImageButton ID="ibEnviarEmail" runat="server" 
                                        ImageUrl="~/Imagenes/EnviarReciboEmail.jpg" 
                                        ToolTip="Enviar comprobantes de pago por correo electrónico" Visible="False" />
                                    <ajaxToolkit:ConfirmButtonExtender ID="ibEnviarEmail_CBE" runat="server" 
                                        ConfirmText="Esta operación podría durar varios minutos, ¿Desea continuar?" 
                                        Enabled="True" TargetControlID="ibEnviarEmail">
                                    </ajaxToolkit:ConfirmButtonExtender>
                                </td>
                                <td>
