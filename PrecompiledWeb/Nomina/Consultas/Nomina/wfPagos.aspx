<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Consultas_Nomina_wfPagos, App_Web_xh1ifbg5" title="COBAEV - Nómina - Consulta de pagos de los empleados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                                            ...
                                            <tr>
                                                <td style="text-align: right">
                                                    <asp:Button ID="btnImprimirReciboPago" runat="server" OnClick="btnConsultarPago_Click"
                                                        SkinID="SkinBoton" Text="Imprimir" ToolTip="Ver recibo de nómina listo para imprimir" />
                                                    &nbsp;<asp:Button ID="btnPrintReciboPagoConImg" runat="server" 
                                                        ...
                                                        ToolTip="Ver recibo de nómina listo para imprimir" Width="160px" />
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; width: 100%; text-align: left" colspan="2">
                                                    <asp:Panel ID="TitlePanelPlazas" runat="server" Width="100%" BorderWidth="1px" BorderStyle="Solid"
                                                        ...
                                                        Plazas vigentes al momento de generar el pago
                                                    ...
                                                    <asp:Panel ID="ContentPanelPlazas" runat="server" Width="100%" CssClass="collapsePanel">
                                                        <asp:GridView ID="gvPlazas" runat="server" Width="100%" SkinID="SkinGridView" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Plaza" HeaderText="Plaza(s) vigentes en la quincena">
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="FechaAlta" HeaderText="Vigencia Inicial de la plaza" DataFormatString="{0:d}">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="FechaBaja" HeaderText="Vigencia Final de la plaza" DataFormatString="{0:d}">
                                                                       <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="DiasPagados" HeaderText="Dias pagados en la quincena">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="Center"  />
                                                                </asp:BoundField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ibVerPercepciones" runat="server" ImageUrl="~/Imagenes/Money.gif"
                                                                            
                                                                            ToolTip="Utilice esta opción si lo que desea es ver los montos que aportó esta plaza al pago quincenal del empleado." 
                                                                            onclick="ibVerPercepciones_Click" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ibDetalles" runat="server" ImageUrl="~/Imagenes/Detalles.gif"
                                                                            ToolTip="Utilice esta opción si lo que desea es ver información más detallada de la plaza." />
