<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="Consulta_PlantelHrsTipoNominaEmps, App_Web_orihxo2e" title="COBAEV - Nómina - Relación plantel-tipo nómina (horas)-empleados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
        ...
        <table style="width: 70%; vertical-align: top; text-align: center;" align="center">
            <tr>
                <td style="vertical-align: top; text-align: left">
                    <h2>
                        Sistema de nómina: Relación Plantel/Tipo nómina (Horas)/Empleados
                    </h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="vertical-align: top; text-align: left">
                    <asp:GridView ID="gvTipoNomina" runat="server" CellPadding="1" SkinID="SkinGridView"
                        Width="100%">
                        <Columns>
                            <asp:TemplateField HeaderText="Abrev. nómina">
                                <ItemTemplate>
                                    <asp:Label ID="lblAbrevTipoNomina" runat="server" Text='<%# Bind("AbrevTipoNomina") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="DescTipoNomina" HeaderText="Nómina">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                        </Columns>
