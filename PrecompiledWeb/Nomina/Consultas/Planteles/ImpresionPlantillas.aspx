<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ImpresionPlantillas, App_Web_orihxo2e" title="COBAEV - Nómina - Reportes por plantel" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlReportes" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlReportes_SelectedIndexChanged"
                                        ...
                                        <asp:ListItem Value="158">PLANTILLA OFICIAL</asp:ListItem>
                                        <asp:ListItem Value="159">CARGA HORARIA POR GRUPOS)</asp:ListItem>
