<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="Consulta_PlantelNombEmps, App_Web_orihxo2e" title="COBAEV - Nómina - Relación plantel-nombramiento (horas)-empleados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
        ...
        <table style="width: 70%; vertical-align: top; text-align: center;" align="center">
            <tr>
                <td style="vertical-align: top; text-align: left">
                    <h2>
                        Sistema de nómina: Relación Plantel/Nombramiento (Horas)/Empleados
                    </h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="vertical-align: top; text-align: left">
                    <asp:GridView ID="gvNombramiento" runat="server" CellPadding="1" SkinID="SkinGridView"
                        Width="100%">
                        <Columns>
                            <asp:TemplateField HeaderText="Abrev. nombramiento">
                                <ItemTemplate>
                                    <asp:Label ID="lblAbrevNombramiento" runat="server" Text='<%# Bind("AbrevNombramiento") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="DescNombramiento" HeaderText="Nombramiento">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                        </Columns>
