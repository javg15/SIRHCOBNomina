<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="Consulta_MateriaEnPlantel, App_Web_orihxo2e" title="COBAEV - Nómina - Relación plantel-materia-empleados" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
        ...
        <table style="width: 70%; vertical-align: top; text-align: center;" align="center">
            <tr>
                <td style="vertical-align: top; text-align: left">
                    <h2>
                        Sistema de nómina: Relación Plantel/Materia/Empleados
                    </h2>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top; text-align: left">
                    <asp:GridView ID="gvMateria" runat="server" CellPadding="1" SkinID="SkinGridView"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Nombremateria2" HeaderText="Descripción materia">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
