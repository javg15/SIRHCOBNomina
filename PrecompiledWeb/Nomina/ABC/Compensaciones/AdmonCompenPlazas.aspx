<%@ page language="VB" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="AdmonCompenPlazas, App_Web_ns2nwdvl" title="COBAEV - Nómina - Compensaciones, Administrar nombramientos" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                                            ...
                                            <asp:UpdatePanel ID="UPQnaFin" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:CompareValidator ID="CVVigencia" runat="server" 
                                                        ...
                                                        Display="None" ErrorMessage="Vigencia incorrecta" Operator="GreaterThanEqual" Type="Integer"></asp:CompareValidator>
                                                </ContentTemplate>
                                                <Triggers>
