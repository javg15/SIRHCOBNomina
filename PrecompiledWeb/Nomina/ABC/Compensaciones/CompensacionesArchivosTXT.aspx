<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="CompensacionesArchivosTXT, App_Web_ns2nwdvl" title="COBAEV - Nómina - Gratificaciones Extraordinarias (Archivos TXT)" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
   ...
   <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: gratificaciones extraordinarias mensuales (Archivos TXT)
                </h2>
            </td>
        </tr>
        <tr>
