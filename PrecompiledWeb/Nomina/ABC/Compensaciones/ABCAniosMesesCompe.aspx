<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Admon_ABCAniosMesesCompe, App_Web_ns2nwdvl" title="COBAEV - Nómina - Gratificaciones Extraordinarias mensuales (Administración de pagos)" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: gratificaciones extraordinarias mensuales (Administración de pagos)
                </h2>
            </td>
        </tr>
    </table>
