<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="GeneraTXTsISSSTE, App_Web_gwndibrm" title="COBAEV - Nómina - ISSSTE archivos TXT" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: ISSSTE (Archivos TXT, con Altas, Bajas y Modificaciones salariales quincenales)
                </h2>
            </td>
        </tr>
        <tr>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlTipoDeArchivo" runat="server" Font-Names="Verdana" Font-Size="X-Small"
                            ...
                            <asp:DropDownList ID="ddlTipoArchivo" runat="server" SkinID="SkinDropDownList" AutoPostBack="True"
                                ...
                                <asp:ListItem Value="0">Altas</asp:ListItem>
                                <asp:ListItem Value="1">Bajas</asp:ListItem>
                                <asp:ListItem Value="3">Bajas (Con número de empleado)</asp:ListItem>
                                <asp:ListItem Value="2">Modificaci&#243;n salarial</asp:ListItem>
                            </asp:DropDownList>
                            <br />
                        </asp:Panel>
                    </ContentTemplate>
