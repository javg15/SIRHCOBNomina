<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="AdmonDatosPagomatico, App_Web_afkwdrmm" title="COBAEV - Nómina - Administrar datos de pagomático" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
            ...
            <tr>
                <td style="vertical-align: top; text-align: right">
                    <h2>
                        ...
                        Empleados (Administrar información de pagomático)
                    </h2>
                </td>
            </tr>
            <tr>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="viewEdit" runat="server">
                            <asp:DetailsView ID="dvDatosLab" runat="server" AutoGenerateRows="False" CellPadding="1"
                                DefaultMode="Edit" EmptyDataText="Sin información de pagomático" HeaderText="Modificando datos de pagomático"
