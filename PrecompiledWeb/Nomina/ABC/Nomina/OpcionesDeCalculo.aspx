<%@ page language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ABC_Nomina_OpcionesDeCalculo, App_Web_sogedhgo" title="COBAEV - Nómina - Opciones de cálculo" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
        ...
        <tr>
            <td align="center">
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="viewCalculoPorZonaGeo" runat="server">
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
                                <asp:Panel ID="pnlPlantel3" runat="server">
                                    <table align="center">
                                        <tr>
                                            <td colspan="2" style="text-align: left;">
                                                <asp:Label ID="lblSelZonaGeo_Op1" runat="server" SkinID="SkinLblMsjExito" 
                                                    Text="Seleccione zona geográfica"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: left">
                                                <asp:DropDownList ID="ddlZonasGeo" runat="server" SkinID="SkinDropDownList">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <asp:CheckBox ID="ChkBxCalculoHaciaAdelanteZG" runat="server" 
                                                    SkinID="SkinCheckBox" 
                                                    Text="Calcular nómina de la zona geográfica seleccionada en adelante" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:Panel ID="pnlPlantel4" runat="server">
                                    <table align="center">
                                        <tbody>
                                            <tr>
                                                <td rowspan="1" style="vertical-align: middle; text-align: center">
                                                    <asp:Image ID="imgCalculando_Op3" runat="server" 
                                                        ImageUrl="~/Imagenes/spinner.gif" Visible="False" />
                                                    <asp:Label ID="lblZonaGeo_Op1" runat="server" SkinID="SkinLblMsjExito" 
                                                        Text="Preparando entorno para iniciar el cálculo, por favor espere..." 
                                                        Visible="False"></asp:Label>
                                                    <asp:Label ID="lblZonaGeo2_Op1" runat="server" Font-Names="Verdana" 
                                                        Font-Size="Small" ForeColor="Navy" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                    <asp:Label ID="lblEmpleado_Op2" runat="server" SkinID="SkinLblMsjExito" 
                                                        Visible="False"></asp:Label>
                                                    <asp:Label ID="lblEmpleado2_Op2" runat="server" Font-Names="Verdana" 
                                                        Font-Size="Small" ForeColor="Navy" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="1" style="vertical-align: top; text-align: center">
                                                    <br />
                                                    <asp:LinkButton ID="lbNuevoCalculoPorZonaGeo" runat="server" 
                                                        SkinID="SkinLinkButton" Visible="False">Realizar nuevo cálculo</asp:LinkButton>
                                                    <br />
                                                    <br />
                                                    <asp:GridView ID="gvErrores4" runat="server" 
                                                        Caption="Errores durante el cálculo" EmptyDataText="Sin errores" 
                                                        SkinID="SkinGridView" Width="100%">
                                                        <Columns>
                                                            <asp:BoundField DataField="RFC" HeaderText="RFC" />
                            ...
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="btnCalcular" EventName="Click" />
                                <asp:AsyncPostBackTrigger ControlID="lbNuevoCalculoPorZonaGeo" 
                                    EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
