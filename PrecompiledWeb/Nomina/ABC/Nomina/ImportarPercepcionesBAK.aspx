<%@ page enableeventvalidation="false" language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ImportarPercepcionesBAK, App_Web_sogedhgo" title="COBAEV - Nómina - Importar percepciones" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
            ...
            <table>
                <tr>
                    <td style="vertical-align: bottom; text-align: left; width: 50%;">
                        <asp:Label ID="Label1" runat="server" SkinID="SkinLblNormal" Text="Seleccione percepción"></asp:Label></td>
                    <td style="vertical-align: bottom; text-align: left; width: 50%;">
                    </td>
                </tr>
                <tr>
                            ...
                            <ContentTemplate>
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="vertical-align: bottom">
                                                <asp:Label ID="lblSelQna" runat="server" SkinID="SkinLblNormal" Text="Seleccione quincena"></asp:Label>&nbsp;<asp:DropDownList ID="ddlQnasAbiertasParaCaptura" runat="server" SkinID="SkinDropDownList">
                                                </asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: bottom"><hr style="color: #004040" />&nbsp;</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </ContentTemplate>
                ...
                <tr>
                    <td style="vertical-align: bottom; width: 50%;">
                        ...
                        <asp:Button ID="btnImportar" runat="server" SkinID="SkinBoton" Text="Importar" />
                                    <asp:Button ID="btnEliminar" runat="server" OnClick="btnEliminar_Click" SkinID="SkinBoton"
                            ...
                            TargetControlID="btnImportar">
                                ...
                                <td style="vertical-align: top; text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                        <asp:Button ID="btnGuardar" runat="server" SkinID="SkinBoton" Text="Guardar" Enabled="False" ToolTip="Guardar información en base de datos" /><ajaxToolkit:ConfirmButtonExtender ID="CBEbtnGuardar" runat="server" ConfirmText="¿Información correcta?"
                ...
                <tr>
                    <td style="vertical-align: top; text-align: left; width: 50%;">
                        <asp:Panel ID="ContentPanelCoincidencias" runat="server" CssClass="collapsePanel" Width="100%">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                <asp:Label ID="lblIdPercepcion" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><asp:Label ID="lblPercepcion" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><br />
                                <asp:GridView ID="gvPercMasivas" runat="server" SkinID="SkinGridView" EmptyDataText="No hubo coincidencias" Width="100%" Visible="False" AutoGenerateColumns="False">
                                    <Columns>
                    ...
                    <td style="vertical-align: top; width: 50%; text-align: left">
                        <asp:Panel ID="ContentPanelInconsistencias" runat="server" CssClass="collapsePanel" Width="100%">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                <asp:Label ID="lblIdPercepcion2" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><asp:Label ID="lblPercepcion2" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><asp:GridView ID="gvInconsistencias" runat="server" SkinID="SkinGridView" EmptyDataText="No hay inconsistencias" Width="100%" Visible="False">
                                    <Columns>
            ...
            <table>
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: left">
                        ...
                        <asp:LinkButton ID="lbExito" runat="server" OnClick="lbExito_Click" SkinID="SkinLinkButton">Continuar</asp:LinkButton></td>
                </tr>
            </table>
        </asp:View>                
    </asp:MultiView>
            ...
            <table>
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: left">
                        ...
                        <asp:LinkButton ID="lbError" runat="server" SkinID="SkinLinkButton">Continuar</asp:LinkButton></td>
                </tr>
            </table>
                        </asp:View>
                    </asp:MultiView>
