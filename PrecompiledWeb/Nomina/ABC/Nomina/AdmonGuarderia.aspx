<%@ page language="VB" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="AdmonGuarderia, App_Web_sogedhgo" title="COBAEV - Nómina - Administrar guardería" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Guardería: Administrar información de hijos
                </h2>
            </td>
        </tr>
    </table>
                                            ...
                                            <td colspan="2" style="vertical-align: top; text-align: left">
                                                <asp:Panel ID="ContentPanelHijos" runat="server" CssClass="collapsePanel" Width="100%">
                                                    <asp:DetailsView ID="dvHijos" runat="server" AutoGenerateRows="False" CellPadding="0"
                                                        DefaultMode="Insert" EmptyDataText="Sin información de hijos" SkinID="SkinDetailsView">
                                                        <Fields>
                                                            ...
                                                            <asp:TemplateField HeaderText="R.F.C.">
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                        <ContentTemplate>
<asp:TextBox id="txtbxRFC" runat="server" SkinID="SkinTextBox" MaxLength="13" Columns="20"></asp:TextBox><asp:RegularExpressionValidator id="REVRFC" runat="server" ValidationExpression="[A-Z]{4}\d{6}[A-Z, 0-9][A-Z, 0-9][A-Z, 0-9]" ControlToValidate="txtbxRFC" Display="None" ErrorMessage="Longitud de RFC no válida" ValidationGroup="GrupoGuardar"></asp:RegularExpressionValidator><ajaxToolkit:FilteredTextBoxExtender id="FTBERFC" runat="server" TargetControlID="txtbxRFC" FilterType="Numbers, UppercaseLetters">
                                                            ...
                                                            <asp:TemplateField HeaderText="C.U.R.P.">
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                        <ContentTemplate>
<asp:TextBox id="txtbxCURP" runat="server" SkinID="SkinTextBox" MaxLength="18" Columns="30"></asp:TextBox><asp:RegularExpressionValidator id="REVCURP" runat="server" ValidationExpression="[A-Z]{4}\d{6}[A-Z]{6}[A-Z, 0-9]{2}" ControlToValidate="txtbxCURP" Display="None" ErrorMessage="Longitud o formato de CURP no válida" ValidationGroup="GrupoGuardar"></asp:RegularExpressionValidator><ajaxToolkit:FilteredTextBoxExtender id="FTBECURP" runat="server" TargetControlID="txtbxCURP" FilterType="Numbers, UppercaseLetters">
                                                                            </ajaxToolkit:FilteredTextBoxExtender> 
</ContentTemplate>
                                                                        <Triggers>
<asp:AsyncPostBackTrigger ControlID="btnGeneraRFC" EventName="Click"></asp:AsyncPostBackTrigger>
                                                            ...
                                                            <asp:TemplateField HeaderText="Fecha de nacimiento">
                                                                <InsertItemTemplate>
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RFVFecNac2" runat="server" ControlToValidate="txtbxFecNac"
                                                                        ...
                                                                        Display="None" ErrorMessage="Fecha no válida" Operator="DataTypeCheck" Type="Date"
                                                                        ValidationGroup="GrupoGuardar"></asp:CompareValidator><asp:CompareValidator ID="CVFecNac2"
                                                                            runat="server" ControlToValidate="txtbxFecNac" Display="None" ErrorMessage="Fecha no válida"
