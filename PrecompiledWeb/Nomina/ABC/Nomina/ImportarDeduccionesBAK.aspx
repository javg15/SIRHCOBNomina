<%@ page enableeventvalidation="false" language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ImportarDeduccionesBAK, App_Web_sogedhgo" title="COBAEV - Nómina - Importar deducciones" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                                                ...
                                                <ContentTemplate>
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="vertical-align: bottom">
                                                                    <asp:Label ID="lblSelQna" runat="server" SkinID="SkinLblNormal" Text="Seleccione quincena"></asp:Label>&nbsp<asp:DropDownList
                                                        ...
                                                        <asp:Label ID="lblIdDeduccion2" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><asp:Label
                                                            ID="lblDeduccion2" runat="server" SkinID="SkinLblNormal" Visible="False"></asp:Label><asp:GridView
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="ImporteDeduccion" DataFormatString="{0:c}" HeaderText="Importe">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="N&#250;m. qnas.">
