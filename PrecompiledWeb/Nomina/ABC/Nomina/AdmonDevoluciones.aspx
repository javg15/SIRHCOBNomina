<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="ABC_Nomina_AdmonDevoluciones, App_Web_sogedhgo" title="COBAEV - Nómina - Administrar devoluciones quincenales" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
<%@ Register Src="../../WebControls/wucSearchEmps2.ascx" TagName="wucSearchEmps2"  TagPrefix="uc1" %>
    ...
    <div>
        ...
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Administración de devoluciones quincenales
                </h2>
            </td>
        </tr>
            <tr>
                        ...
                        <asp:View ID="viewOperacion" runat="server">
                            ...
                            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="1" BackColor="#FFFBD6" BorderColor="#FFDFAD"
                                BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" 
                                        FinishCompleteButtonText="Guardar" Font-Italic="False" Height="300px" 
                                        OnNextButtonClick="Wizard1_NextButtonClick" Width="100%" 
                                        OnFinishButtonClick="Wizard1_FinishButtonClick" HeaderText="Empleado" 
                                ...
                                <WizardSteps>
                                    ...
                                    <asp:WizardStep runat="server" Title="Tipo de devoluci&#243;n">
                                                <asp:Label ID="lblTipoDevolucion" runat="server" SkinID="SkinLblNormal" Text="Tipo de devoluci&#243;n:"></asp:Label>
                                        <br />
                                        <asp:DropDownList
                                                    ID="ddlTipoDeDevolucion" runat="server" SkinID="SkinDropDownList">
                                                </asp:DropDownList>
                                        <br />
                                    </asp:WizardStep>
                                    <asp:WizardStep runat="server" Title="Per&#237;odo">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td colspan="2" style="text-align: left">
                                                    <asp:Label ID="Label4" runat="server" SkinID="SkinLblNormal" Text="Período devolución"></asp:Label></td>
                                                <td colspan="1" style="text-align: left">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server" Text="Iniciar descuentos en la quincena" SkinID="SkinLblNormal"></asp:Label></td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Inicio" SkinID="SkinLblNormal"></asp:Label></td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server" SkinID="SkinLblNormal" Text="Fin"></asp:Label></td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="ddlQnaAplic" runat="server" SkinID="SkinDropDownList" AutoPostBack="True" Width="100px">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="chbxDescEnAdic" runat="server" SkinID="SkinCheckBox" Text="Descontar en adicionales" /></td>
                                                <td>
                                                    <asp:CheckBox ID="chbxIncluirAdic" runat="server" SkinID="SkinCheckBox" Text="Incluir adicionales" AutoPostBack="True" OnCheckedChanged="chbxIncluirAdic_CheckedChanged" /></td>
                                                <td>
                                                </td>
                                                <td>
                                                </td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label8" runat="server" SkinID="SkinLblNormal" Text="Dividir descuento en"></asp:Label>
                                                </td>
                                                <td style="width: 25px">
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server" SkinID="SkinLblNormal" Text="Quincenas devueltas"></asp:Label></td>
                                                <td style="width: 25px">
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server" SkinID="SkinLblNormal" Text="Restar a quincena final"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top">
                                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                        <ContentTemplate>
                                                    <asp:TextBox ID="txtbxNumPagos" runat="server" MaxLength="2" SkinID="SkinTextBox"
                                                        ValidationGroup="Grupo1" Width="50px">1</asp:TextBox>
                                                    <asp:Label ID="Label9" runat="server" SkinID="SkinLblNormal" Text="quincena(s)"></asp:Label>
                                                    <ajaxToolkit:FilteredTextBoxExtender
                                                            ID="FTBENumPagos" runat="server" FilterType="Numbers" TargetControlID="txtbxNumPagos" Enabled="True">
                                                    </ajaxToolkit:FilteredTextBoxExtender>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chbxDescMaximoPosible" EventName="CheckedChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </td>
                                                <td style="width: 25px">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button ID="btnUpdQnaIni" runat="server" SkinID="SkinBoton" Text="Actualizar"
                                                        ToolTip="Actualizar la quincena inicial del per&#237;odo de adeudo" ValidationGroup="Grupo1" /><ajaxToolkit:FilteredTextBoxExtender
                                                            ID="FTBENumQnas" runat="server" FilterType="Numbers" TargetControlID="txtbxNumQnas" Enabled="True">
                                                        </ajaxToolkit:FilteredTextBoxExtender>
                                                    &nbsp;&nbsp;
                                                </td>
                                                <td style="width: 25px">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button
                                                        ID="btnUpdQnaFin" runat="server" SkinID="SkinBoton" Text="Actualizar" ToolTip="Actualizar la quincena final del per&#237;odo de adeudo" ValidationGroup="Grupo1" /><ajaxToolkit:FilteredTextBoxExtender
                                                            ID="FTBEQnasARestar" runat="server" FilterType="Numbers" TargetControlID="txtbxQnasARestar" Enabled="True">
                                                        </ajaxToolkit:FilteredTextBoxExtender>
                                                    &nbsp;
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top">
                                                    <asp:RangeValidator ID="RVNumPagos" runat="server" ControlToValidate="txtbxNumPagos"
                                                        Display="Dynamic" ErrorMessage="Valores permitidos [1-99]" Font-Size="Small" MaximumValue="99"
                                                        MinimumValue="1" Type="Integer" ValidationGroup="Grupo1"></asp:RangeValidator>
                                                    <asp:RequiredFieldValidator ID="RFVNumPagos" runat="server" ControlToValidate="txtbxNumPagos"
                                                ...
                                                <td style="vertical-align: top">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RFVQnasARestar" runat="server" ControlToValidate="txtbxQnasARestar"
                                                        Display="Dynamic" ErrorMessage="Valor requerido" Font-Size="Small" ValidationGroup="Grupo1"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top">
                                                    <asp:CheckBox ID="chbxDescMaximoPosible" runat="server" AutoPostBack="True" OnCheckedChanged="chbxDescMaximoPosible_CheckedChanged"
                                                        SkinID="SkinCheckBox" Text="Aplicar descuento m&#225;ximo quincenal" />
                                                </td>
                                                <td style="width: 25px">
                                                </td>
                                                <td style="vertical-align: top">
                                            ...
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="gvQnasDias" runat="server" Caption="Días por quincena"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="D&#237;as a considerar para la devoluci&#243;n">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtbxNumDias" runat="server" MaxLength="2" SkinID="SkinTextBox"
                                                                                Text='<%# Bind("NumDias") %>' Width="50px"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="FTBENumDias" runat="server" FilterType="Numbers" TargetControlID="txtbxNumDias">
                                                                            </ajaxToolkit:FilteredTextBoxExtender>
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chbxIncluirAdic" EventName="CheckedChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
                                    ...
                                    <asp:WizardStep runat="server" Title="Carga horaria">
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                        <asp:GridView ID="gvCargaHoraria" runat="server" AutoGenerateColumns="False" EmptyDataText="Empleado administrativo (no se requiere carga horaria) o Docente sin carga horaria definida." SkinID="SkinGridViewEmpty"
                                            Width="100%">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                    ...
                                    <asp:WizardStep runat="server" Title="Finalizar">
                                        <asp:Label ID="lblFinalizar" runat="server" SkinID="SkinLblNormal" Text="Para terminar la captura/modificaci&#243;n/eliminaci&#243;n de la devoluci&#243;n, haga click en el bot&#243;n correspondiente."></asp:Label>
                                        &nbsp;&nbsp;<br />
                                ...
                                <SideBarStyle BackColor="#990000" Font-Size="0.9em" VerticalAlign="Top" HorizontalAlign="Left" Wrap="True" Width="15%" />
