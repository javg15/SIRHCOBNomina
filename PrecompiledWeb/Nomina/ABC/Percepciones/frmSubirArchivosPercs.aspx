<%@ page enableeventvalidation="false" language="VB" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="frmSubirArchivosPercs, App_Web_ou3vf2bz" title="COBAEV - Nómina - Subir archivos de percepciones para aplicar en nómina" stylesheettheme="SkinFile" culture="es-MX" uiculture="es" maintainScrollPositionOnPostBack="true" %>
                ...
                <table style="width: 100%;" align="center">
                    <tr>
                        <td style="vertical-align: top; text-align: right">
                            <h2>
                                Sistema de nómina: Subir archivos de percepciones para aplicar en nómina
                            </h2>
                        </td>
                    </tr>
                    <tr>
