<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageBlanca.master" autoeventwireup="false" inherits="ABC_Recibos_AdmonDetallesRecibosBAK, App_Web_5lgpnrst" title="COBAEV - Nómina - Administrar los detalles del recibo" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle; width: 150px">
                                                <asp:ImageButton ID="ibImprimir" runat="server" ImageUrl="~/Imagenes/Printer1.jpg"
                                                    ToolTip="Mostrar recibo para impresión" />
                                                <asp:ImageButton ID="ibDevolucion" runat="server" ImageUrl="~/Imagenes/Devolucion.jpg"
                                                    ToolTip="Generar devolución del recibo" Visible="False" /><asp:ImageButton ID="ibEliminarDevolucion"
                                            ...
                                            <td style="vertical-align: middle; text-align: right;">
                                                ...
                                                <ajaxToolkit:ConfirmButtonExtender ID="CBEibEliminarDevolucion" runat="server" ConfirmText="Esta operación eliminará la devolución generada para el recibo, ¿Continuar?"
                                                    TargetControlID="ibEliminarDevolucion">
                                                </ajaxToolkit:ConfirmButtonExtender>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td style="width: 100%; text-align: left;">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="btnGeneraRecibo" EventName="Click" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
