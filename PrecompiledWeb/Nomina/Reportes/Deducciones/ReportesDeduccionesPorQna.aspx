<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ReportesDeduccionesPorQna, App_Web_cchcgmxa" title="COBAEV - Nómina - Reportes sobre terceros institucionales" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Terceros institucionales (Reportes)
                </h2>
            </td>
        </tr>
        <tr>
