<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Reportes_Categorias_TabuladoresPorCategoria, App_Web_kpyrjfq2" title="COBAEV - Nómina - Impresión de reportes relacionados a las categorías" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Tabuladores (Reportes)
                </h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: left; vertical-align: top; height: 199px;">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlPlanteles_ZonasGeo" runat="server" Font-Names="Verdana" Font-Size="X-Small">
                            <br />
                            <asp:DropDownList ID="ddlZonasEco" runat="server" SkinID="SkinDropDownList" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlZonasEco_SelectedIndexChanged">
                            </asp:DropDownList>
                            <br />
                            <br />
                        </asp:Panel>
            ...
            <td style="text-align: left">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="ddlZonasEco" EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="gvReportes" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
