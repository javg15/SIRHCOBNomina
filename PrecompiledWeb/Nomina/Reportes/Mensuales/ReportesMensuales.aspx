<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="Reportes_Mensuales, App_Web_au3opsai" title="COBAEV - Nómina - Impresión de reportes mensuales" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Reportes mensuales
                </h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <asp:Panel ID="pnlMeses" runat="server" Font-Names="Verdana" Font-Size="X-Small"
                GroupingText="Meses pagados durante el año" HorizontalAlign="Left">
                <br />
        ...
        <tr>
            <td style="text-align: left">
                <asp:Panel ID="pnlTipoDeNomina" runat="server" Font-Names="Verdana" 
                    Font-Size="X-Small" GroupingText="Seleccione tipo de nómina" HorizontalAlign="Left">
                    <br />
