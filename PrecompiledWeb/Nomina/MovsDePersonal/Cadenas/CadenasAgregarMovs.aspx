<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="CadenasAgregarMovs, App_Web_gy0kusdy" title="COBAEV - Nómina - Cadenas, agregar movimientos" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; height: 300px" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: Cadenas (Agregar movimientos)
                </h2>
            </td>
        </tr>
        <tr>
                                                        ...
                                                        <asp:GridView ID="gvPlazasVigentes" runat="server" EmptyDataText="Sin plazas vigentes"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Cadena">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <EditItemTemplate>
                                                                        <asp:Label ID="lblIdCadena" runat="server" Visible="False"></asp:Label><asp:DropDownList
                                                                            ID="ddlCadenas" runat="server" SkinID="SkinDropDownList">
                                                                        </asp:DropDownList>
                                                                    </EditItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Tipo Mov.">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                    <EditItemTemplate>
                                                                        <asp:Label ID="lblTipoMov" runat="server" Visible="False"></asp:Label><asp:DropDownList
                                                                            ID="ddlTipoMov" runat="server" SkinID="SkinDropDownList">
                                                                ...
                                                                <asp:TemplateField ShowHeader="False">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ibEditar" runat="server" CausesValidation="False" ImageUrl="~/Imagenes/Modificar.png"
                                                                            ToolTip="Modificar cadena a la que pertenece el movimiento" OnClick="ibEditar_Click" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        ...
                                                        <asp:GridView ID="gvPlazasHistoria" runat="server" EmptyDataText="Sin historia de plazas"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ShowHeader="False">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ibEditar" runat="server" CausesValidation="False" ImageUrl="~/Imagenes/Modificar.png"
                                                                            ToolTip="Modificar cadena a la que pertenece el movimiento" OnClick="ibEditar_Click1" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                            </Columns>
