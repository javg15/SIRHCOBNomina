<%@ page language="VB" enableeventvalidation="false" masterpagefile="~/MasterPageSesionIniciada.master" autoeventwireup="false" inherits="ABCSalariosMinimos, App_Web_wdwpyhsd" title="COBAEV - Nómina - ABC Salarios mínimos" stylesheettheme="SkinFile" maintainScrollPositionOnPostBack="true" %>
    ...
    <table style="width: 100%; vertical-align: top; text-align: center; height: 100%;" align="center">
        <tr>
            <td style="vertical-align: top; text-align: right">
                <h2>
                    Sistema de nómina: ABC Salarios Mínimos</h2>
            </td>
        </tr>
        <tr>
                                ...
                                <asp:TemplateField HeaderText="Modificar">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibEditar" runat="server" CausesValidation="False"
                                            ImageUrl="~/Imagenes/Modificar.png" ToolTip="Modificar valores para ésta zona económica" 
                                ...
                                <asp:TemplateField HeaderText="Nuevo valores">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibNuevosValores" runat="server" ImageUrl="~/Imagenes/Add2.png"
                                            ToolTip="Capturar nuevos valores para ésta zona económica" onclick="ibNuevosValores_Click" 
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:Label ID="lblImporteSMG" runat="server" SkinID="SkinLblNormal" 
                                        Text="Importe Salario Mínimo"></asp:Label>
                                </td>
                                <td style="text-align: left">
