<%@ Control Language="VB" EnableViewState="true" AutoEventWireup="false" CodeFile="wucUpdateProgress.ascx.vb"
    Inherits="WebControls_wucUpdateProgress" %>
<div>
                    ...
                    <tr>
                        <td colspan="2" style="vertical-align: middle; text-align: center">
                            <asp:Button ID="btnCancelar" runat="server" OnClientClick="javascript:CancelPostBack(); return false;"
                                SkinID="SkinBoton" Text="Cancelar" Visible="False" />
                        </td>
                    </tr>
                </table>
                <br />
