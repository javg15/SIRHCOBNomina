<%@ Page Language="VB" EnableEventValidation="false" MasterPageFile="~/MasterPageSesionIniciada.master"
    AutoEventWireup="false" CodeFile="Puestos.aspx.vb" Inherits="MovsDePersonal_Puestos"
    Title="COBAEV - Nómina - Puestos" StylesheetTheme="SkinFile" MaintainScrollPositionOnPostback = "true"  %>
