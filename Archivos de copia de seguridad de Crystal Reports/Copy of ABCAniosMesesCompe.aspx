<%@ Page Language="VB" enableEventValidation="false" MasterPageFile="~/MasterPageSesionIniciada.master" 
    AutoEventWireup="false" CodeFile="Copy of ABCAniosMesesCompe.aspx.vb" Inherits="Admon_ABCAniosMesesCompeCopy" 
    title="COBAEV - Nómina - Compensaciones mensuales (Administración de pagos)" StylesheetTheme="SkinFile" %>
