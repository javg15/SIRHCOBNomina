<%@ Control Language="VB" EnableViewState="true" AutoEventWireup="false" CodeFile="wucSearchEmpsAux.ascx.vb"
    Inherits="WebControls_wucSearchEmpsAux" %>
                ...
                <table style="padding: 0px; margin: 0px; width: 100%;">
                    <tr>
                        <td style="vertical-align: top; text-align: left">
                            <asp:Panel ID="ContentPanelBusqueda" runat="server"  Width="100%" GroupingText="Empleado al que afectará el movimiento:">
